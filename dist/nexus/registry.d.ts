...
export declare function custodian_id_(custodian_capability_ref: CustodianCapability, $c: AptosDataCache): U64;
export declare function destroy_custodian_capability_test_(custodian_capability: CustodianCapability, $c: AptosDataCache): void;
export declare function get_custodian_capability_test_(custodian_id: U64, $c: AptosDataCache): CustodianCapability;
export declare function get_verified_market_custodian_id_(market_id: U64, $c: AptosDataCache, $p: TypeTag[]): U64;
export declare function init_registry_(account: HexString, $c: AptosDataCache): void;
...
export declare function is_base_asset_(market_info: MarketInfo, $c: AptosDataCache, $p: TypeTag[]): boolean;
export declare function is_base_or_quote_(market_info: MarketInfo, $c: AptosDataCache, $p: TypeTag[]): boolean;
export declare function is_registered_custodian_id_(custodian_id: U64, $c: AptosDataCache): boolean;
export declare function is_registered_trading_pair_(trading_pair_info: TradingPairInfo, $c: AptosDataCache): boolean;
export declare function n_custodians_($c: AptosDataCache): U64;
export declare function n_markets_($c: AptosDataCache): U64;
export declare function register_custodian_capability_($c: AptosDataCache): CustodianCapability;
export declare function register_market_internal_(host: HexString, lot_size: U64, tick_size: U64, generic_asset_transfer_custodian_id: U64, $c: AptosDataCache, $p: TypeTag[]): U64;
export declare function set_registered_custodian_test_(custodian_id: U64, $c: AptosDataCache): void;
...
export declare class App {
    ...
    loadRegistry(owner: HexString, loadFull?: boolean): Promise<Registry>;
    ...
    init_registry(_account: AptosAccount, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
