...
function burn_(coins, $c, $p) {
    let burn_capability;
    burn_capability = $c.borrow_global(new move_to_ts_2.SimpleStructTag(CoinCapabilities, [$p[0]]), new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa")).burn_capability;
    Stdlib.Coin.burn_(coins, burn_capability, $c, [$p[0]]);
    return;
}
exports.burn_ = burn_;
function init_all_coin_types_(account, $c) {
    init_coin_type_(account, $.copy(exports.BASE_COIN_NAME), $.copy(exports.BASE_COIN_SYMBOL), $.copy(exports.BASE_COIN_DECIMALS), $c, [new move_to_ts_2.SimpleStructTag(BC)]);
    init_coin_type_(account, $.copy(exports.QUOTE_COIN_NAME), $.copy(exports.QUOTE_COIN_SYMBOL), $.copy(exports.QUOTE_COIN_DECIMALS), $c, [new move_to_ts_2.SimpleStructTag(QC)]);
    init_coin_type_(account, [(0, move_to_ts_1.u8)("65"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("116"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("115")], [(0, move_to_ts_1.u8)("65"), (0, move_to_ts_1.u8)("80"), (0, move_to_ts_1.u8)("84")], $.copy(exports.QUOTE_COIN_DECIMALS), $c, [new move_to_ts_2.SimpleStructTag(APT)]);
    init_coin_type_(account, [(0, move_to_ts_1.u8)("83"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("105")], [(0, move_to_ts_1.u8)("83"), (0, move_to_ts_1.u8)("85"), (0, move_to_ts_1.u8)("73")], $.copy(exports.QUOTE_COIN_DECIMALS), $c, [new move_to_ts_2.SimpleStructTag(SUI)]);
    init_coin_type_(account, [(0, move_to_ts_1.u8)("85"), (0, move_to_ts_1.u8)("83"), (0, move_to_ts_1.u8)("32"), (0, move_to_ts_1.u8)("68"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("97"), (0, move_to_ts_1.u8)("114"), (0, move_to_ts_1.u8)("32"), (0, move_to_ts_1.u8)("67"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("105"), (0, move_to_ts_1.u8)("110")], [(0, move_to_ts_1.u8)("85"), (0, move_to_ts_1.u8)("83"), (0, move_to_ts_1.u8)("68"), (0, move_to_ts_1.u8)("67")], $.copy(exports.QUOTE_COIN_DECIMALS), $c, [new move_to_ts_2.SimpleStructTag(USDC)]);
    ...
    init_coin_type_(account, [(0, move_to_ts_1.u8)("83"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("97"), (0, move_to_ts_1.u8)("110"), (0, move_to_ts_1.u8)("97")], [(0, move_to_ts_1.u8)("83"), (0, move_to_ts_1.u8)("79"), (0, move_to_ts_1.u8)("76")], $.copy(exports.QUOTE_COIN_DECIMALS), $c, [new move_to_ts_2.SimpleStructTag(SOL)]);
    return;
}
...
function buildPayload_init_all_coin_types(isJSON = false) {
    ...
    return $.buildPayload(new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "assets", "init_all_coin_types", typeParamStrings, [], isJSON);
}
...
function init_coin_type_(account, coin_name, coin_symbol, decimals, $c, $p) {
    ...
    if (!!$c.exists(new move_to_ts_2.SimpleStructTag(CoinCapabilities, [$p[0]]), new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"))) {
    ...
    $c.move_to(new move_to_ts_2.SimpleStructTag(CoinCapabilities, [$p[0]]), account, new CoinCapabilities({ burn_capability: $.copy(burn_capability), freeze_capability: $.copy(freeze_capability), mint_capability: $.copy(mint_capability) }, new move_to_ts_2.SimpleStructTag(CoinCapabilities, [$p[0]])));
    return;
}
...
function buildPayload_init_coin_types(isJSON = false) {
    const typeParamStrings = [];
    return $.buildPayload(new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "assets", "init_coin_types", typeParamStrings, [], isJSON);
}
...
function mint_(account, amount, $c, $p) {
    ...
    if (!(($.copy(account_address)).hex() === (new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa")).hex())) {
        throw $.abortCode($.copy(exports.E_NOT_ECONIA));
    }
    if (!$c.exists(new move_to_ts_2.SimpleStructTag(CoinCapabilities, [$p[0]]), $.copy(account_address))) {
        throw $.abortCode($.copy(exports.E_NO_CAPABILITIES));
    }
    mint_capability = $c.borrow_global(new move_to_ts_2.SimpleStructTag(CoinCapabilities, [$p[0]]), $.copy(account_address)).mint_capability;
...
function buildPayload_mint(amount, $p, /* <CoinType>*/ isJSON = false) {
    ...
    return $.buildPayload(new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "assets", "mint", typeParamStrings, [
        amount,
    ], isJSON);
}
...
function buildPayload_mint_and_deposit(amount, $p, /* <CoinType>*/ isJSON = false) {
    const typeParamStrings = $p.map(t => $.getTypeTagFullname(t));
    return $.buildPayload(new aptos_1.HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "assets", "mint_and_deposit", typeParamStrings, [
        amount,
    ], isJSON);
}
...
class App {
    ...
    mint_and_deposit(_account, amount, $p, /* <CoinType>*/ _maxGas = 1000, _isJSON = false) {
        return __awaiter(this, void 0, void 0, function* () {
