...
export declare function burn_(coins: Stdlib.Coin.Coin, $c: AptosDataCache, $p: TypeTag[]): void;
export declare function init_all_coin_types_(account: HexString, $c: AptosDataCache): void;
...
export declare function init_coin_type_(account: HexString, coin_name: U8[], coin_symbol: U8[], decimals: U8, $c: AptosDataCache, $p: TypeTag[]): void;
export declare function init_coin_types_(account: HexString, $c: AptosDataCache): void;
...
export declare function mint_(account: HexString, amount: U64, $c: AptosDataCache, $p: TypeTag[]): Stdlib.Coin.Coin;
...
export declare function mint_and_deposit_(account: HexString, amount: U64, $c: AptosDataCache, $p: TypeTag[]): void;
...
export declare class App {
    ...
    loadCoinCapabilities(owner: HexString, $p: TypeTag[], /* <CoinType> */ loadFull?: boolean): Promise<CoinCapabilities>;
    get ETH(): typeof ETH;
    get QC(): typeof QC;
    get QG(): typeof QG;
    get SOL(): typeof SOL;
    ...
    init_all_coin_types(_account: AptosAccount, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    init_coin_types(_account: AptosAccount, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    mint(_account: AptosAccount, amount: U64, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    mint_and_deposit(_account: AptosAccount, amount: U64, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
