...
export declare function burn_(
  coins: Stdlib.Coin.Coin,
  $c: AptosDataCache,
  $p: TypeTag[]
): void;
export declare function init_all_coin_types_(
  account: HexString,
  $c: AptosDataCache
): void;
export declare function buildPayload_init_all_coin_types(
  isJSON?: boolean
):
  | TxnBuilderTypes.TransactionPayloadEntryFunction
  | Types.TransactionPayload_EntryFunctionPayload;
export declare function init_coin_type_(
  account: HexString,
  coin_name: U8[],
  coin_symbol: U8[],
  decimals: U8,
...
export declare function init_coin_types_(
  account: HexString,
  $c: AptosDataCache
): void;
export declare function buildPayload_init_coin_types(
  isJSON?: boolean
):
  | TxnBuilderTypes.TransactionPayloadEntryFunction
  | Types.TransactionPayload_EntryFunctionPayload;
export declare function mint_(
  account: HexString,
  amount: U64,
  $c: AptosDataCache,
  $p: TypeTag[]
): Stdlib.Coin.Coin;
export declare function buildPayload_mint(
  amount: U64,
  $p: TypeTag[],
  /* <CoinType>*/ isJSON?: boolean
):
  | TxnBuilderTypes.TransactionPayloadEntryFunction
  | Types.TransactionPayload_EntryFunctionPayload;
export declare function mint_and_deposit_(
  account: HexString,
  amount: U64,
  $c: AptosDataCache,
  $p: TypeTag[]
): void;
export declare function buildPayload_mint_and_deposit(
  amount: U64,
  $p: TypeTag[],
  /* <CoinType>*/ isJSON?: boolean
):
...
export declare class App {
  ...
  loadCoinCapabilities(
    owner: HexString,
    $p: TypeTag[],
    /* <CoinType> */ loadFull?: boolean
  ): Promise<CoinCapabilities>;
  get ETH(): typeof ETH;
  get QC(): typeof QC;
  get QG(): typeof QG;
