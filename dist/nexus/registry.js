...
exports.App =
  exports.loadParsers =
  exports.set_registered_custodian_test_ =
  exports.register_market_internal_ =
  exports.register_custodian_capability_ =
  exports.n_markets_ =
  exports.n_custodians_ =
  exports.is_registered_trading_pair_ =
  exports.is_registered_custodian_id_ =
  exports.is_base_or_quote_ =
  exports.is_base_asset_ =
  exports.buildPayload_init_registry =
  exports.init_registry_ =
  exports.get_verified_market_custodian_id_ =
  exports.get_custodian_capability_test_ =
  exports.destroy_custodian_capability_test_ =
  exports.custodian_id_ =
  exports.TradingPairInfo =
  exports.Registry =
  exports.MarketInfo =
  exports.GenericAsset =
  exports.CustodianCapability =
  exports.PURE_COIN_PAIR =
  exports.NO_CUSTODIAN =
  exports.E_TICK_SIZE_0 =
  exports.E_SAME_COIN =
  exports.E_REGISTRY_EXISTS =
  exports.E_NO_REGISTRY =
  exports.E_NOT_IN_MARKET_PAIR =
  exports.E_NOT_NEXUS =
  exports.E_MARKET_EXISTS =
  exports.E_LOT_SIZE_0 =
  exports.E_INVALID_QUOTE_ASSET =
  exports.E_INVALID_MARKET_ID =
  exports.E_INVALID_CUSTODIAN =
  exports.E_INVALID_BASE_ASSET =
  exports.moduleName =
...
Registry.fields = [
  ...
  {
    name: "markets",
    typeTag: new move_to_ts_2.VectorTag(
      new move_to_ts_2.StructTag(
        new aptos_1.HexString(
          "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"
        ),
...
class TradingPairInfo {
  constructor(proto, typeTag) {
    ...
    this.generic_asset_transfer_custodian_id =
      proto["generic_asset_transfer_custodian_id"];
...
TradingPairInfo.fields = [
  ...
  {
    name: "generic_asset_transfer_custodian_id",
    typeTag: move_to_ts_2.AtomicTypeTag.U64,
  },
...
function get_custodian_capability_test_(custodian_id, $c) {
  return new CustodianCapability(
    ...
    new move_to_ts_2.SimpleStructTag(CustodianCapability)
  );
}
...
function get_verified_market_custodian_id_(market_id, $c, $p) {
  ...
  if (
    !$c.exists(
      new move_to_ts_2.SimpleStructTag(Registry),
      new aptos_1.HexString(
        "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"
      )
    )
  ...
  if (
    !$.copy(market_id).lt(
      Stdlib.Vector.length_(registry_ref.markets, $c, [
        new move_to_ts_2.SimpleStructTag(MarketInfo),
      ])
    )
  ) {
    throw $.abortCode($.copy(exports.E_INVALID_MARKET_ID));
  }
  trading_pair_info_ref = Stdlib.Vector.borrow_(
    registry_ref.markets,
    $.copy(market_id),
    $c,
    [new move_to_ts_2.SimpleStructTag(MarketInfo)]
  ).trading_pair_info;
  if (
    !$.deep_eq(
      $.copy(trading_pair_info_ref.base_type_info),
  ...
  if (
    !$.deep_eq(
      $.copy(trading_pair_info_ref.quote_type_info),
...
function init_registry_(account, $c) {
  ...
  $c.move_to(
    ...
    new Registry(
      {
        hosts: Stdlib.Table.new___($c, [
          new move_to_ts_2.SimpleStructTag(TradingPairInfo),
          move_to_ts_2.AtomicTypeTag.Address,
        ]),
        markets: Stdlib.Vector.empty_($c, [
          new move_to_ts_2.SimpleStructTag(MarketInfo),
        ]),
        n_custodians: (0, move_to_ts_1.u64)("0"),
      },
      new move_to_ts_2.SimpleStructTag(Registry)
    )
  );
...
function is_base_asset_(market_info, $c, $p) {
  ...
  if (
    $.deep_eq(
      $.copy(type_info),
      $.copy(market_info.trading_pair_info.base_type_info)
    )
  ) {
    return true;
  } else {
  ...
  if (
    $.deep_eq(
      $.copy(type_info),
      $.copy(market_info.trading_pair_info.quote_type_info)
    )
  ) {
    return false;
  } else {
...
function register_custodian_capability_($c) {
  ...
  registry_ref_mut = $c.borrow_global_mut(
    new move_to_ts_2.SimpleStructTag(Registry),
    new aptos_1.HexString(
      "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"
    )
  );
  custodian_id = $.copy(registry_ref_mut.n_custodians).add(
...
function register_market_internal_(
  host,
  lot_size,
  tick_size,
  ...
  trading_pair_info = new TradingPairInfo(
    {
      base_type_info: $.copy(base_type_info),
      quote_type_info: $.copy(quote_type_info),
      lot_size: $.copy(lot_size),
      tick_size: $.copy(tick_size),
      generic_asset_transfer_custodian_id: $.copy(
        generic_asset_transfer_custodian_id
      ),
      agnostic_disambiguator: $.copy(agnostic_disambiguator),
    },
    new move_to_ts_2.SimpleStructTag(TradingPairInfo)
  );
  if (pure_coin) {
    ...
    if (
      !$.copy(generic_asset_transfer_custodian_id).eq(
        $.copy(exports.PURE_COIN_PAIR)
      )
    ) {
    ...
    if (
      !is_registered_custodian_id_(
        $.copy(generic_asset_transfer_custodian_id),
        $c
      )
    ) {
      throw $.abortCode($.copy(exports.E_INVALID_CUSTODIAN));
  ...
  Stdlib.Vector.push_back_(
    registry_ref_mut.markets,
    new MarketInfo(
      { host: $.copy(host), trading_pair_info: $.copy(trading_pair_info) },
      new move_to_ts_2.SimpleStructTag(MarketInfo)
    ),
    $c,
    [new move_to_ts_2.SimpleStructTag(MarketInfo)]
...
function set_registered_custodian_test_(custodian_id, $c) {
  ...
  ).n_custodians = $.copy(custodian_id);
  return;
}
exports.set_registered_custodian_test_ = set_registered_custodian_test_;
function loadParsers(repo) {
  repo.addParser(
    "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa::registry::CustodianCapability",
    CustodianCapability.CustodianCapabilityParser
  );
  repo.addParser(
    "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa::registry::GenericAsset",
    GenericAsset.GenericAssetParser
  );
  repo.addParser(
    "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa::registry::MarketInfo",
    MarketInfo.MarketInfoParser
  );
  repo.addParser(
    "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa::registry::Registry",
    Registry.RegistryParser
  );
  repo.addParser(
    "0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa::registry::TradingPairInfo",
