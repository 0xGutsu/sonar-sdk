...
export declare class App {
    ...
    loadStore(owner: HexString, loadFull?: boolean): Promise<Store>;
    ...
    add_stake(_account: AptosAccount, operator: HexString, amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    create_staking_contract(_account: AptosAccount, operator: HexString, voter: HexString, amount: U64, commission_percentage: U64, contract_creation_seed: U8[], _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    distribute(_account: AptosAccount, staker: HexString, operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    request_commission(_account: AptosAccount, staker: HexString, operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    reset_lockup(_account: AptosAccount, operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    switch_operator(_account: AptosAccount, old_operator: HexString, new_operator: HexString, new_commission_percentage: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    switch_operator_with_same_commission(_account: AptosAccount, old_operator: HexString, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    unlock_rewards(_account: AptosAccount, operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    unlock_stake(_account: AptosAccount, operator: HexString, amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    update_voter(_account: AptosAccount, operator: HexString, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
