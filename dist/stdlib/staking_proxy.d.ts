...
export declare class App {
    ...
    set_operator(_account: AptosAccount, old_operator: HexString, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_stake_pool_operator(_account: AptosAccount, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_stake_pool_voter(_account: AptosAccount, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_staking_contract_operator(_account: AptosAccount, old_operator: HexString, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_staking_contract_voter(_account: AptosAccount, operator: HexString, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_vesting_contract_operator(_account: AptosAccount, old_operator: HexString, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_vesting_contract_voter(_account: AptosAccount, operator: HexString, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_voter(_account: AptosAccount, operator: HexString, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
