...
export declare class App {
    ...
    loadCapabilities(owner: HexString, $p: TypeTag[], /* <CoinType> */ loadFull?: boolean): Promise<Capabilities>;
    ...
    burn(_account: AptosAccount, amount: U64, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    initialize(_account: AptosAccount, name: U8[], symbol: U8[], decimals: U8, monitor_supply: boolean, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    mint(_account: AptosAccount, dst_addr: HexString, amount: U64, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    register(_account: AptosAccount, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
