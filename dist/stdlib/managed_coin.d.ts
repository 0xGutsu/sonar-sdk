...
export declare function burn_(account: HexString, amount: U64, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
...
export declare function initialize_(account: HexString, name: U8[], symbol: U8[], decimals: U8, monitor_supply: boolean, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
...
export declare function mint_(account: HexString, dst_addr: HexString, amount: U64, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
