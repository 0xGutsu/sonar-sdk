...
export declare function create_account_(new_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function create_account_unchecked_(new_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function create_authorized_signer_(account: HexString, offerer_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function create_framework_reserved_account_(addr: HexString, $c: AptosDataCache): Promise<[HexString, SignerCapability]>;
export declare function create_guid_(account_signer: HexString, $c: AptosDataCache): Promise<Guid.GUID>;
export declare function create_resource_account_(source: HexString, seed: U8[], $c: AptosDataCache): Promise<[HexString, SignerCapability]>;
export declare function create_resource_address_(source: HexString, seed: U8[], $c: AptosDataCache): Promise<HexString>;
export declare function create_signer_(addr: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function create_signer_with_capability_(capability: SignerCapability, $c: AptosDataCache): Promise<HexString>;
export declare function exists_at_(addr: HexString, $c: AptosDataCache): Promise<boolean>;
export declare function get_authentication_key_(addr: HexString, $c: AptosDataCache): Promise<U8[]>;
export declare function get_guid_next_creation_num_(addr: HexString, $c: AptosDataCache): Promise<U64>;
export declare function get_sequence_number_(addr: HexString, $c: AptosDataCache): Promise<U64>;
export declare function get_signer_capability_address_(capability: SignerCapability, $c: AptosDataCache): Promise<HexString>;
export declare function increment_sequence_number_(addr: HexString, $c: AptosDataCache): Promise<void>;
export declare function initialize_(aptos_framework: HexString, $c: AptosDataCache): Promise<void>;
export declare function new_event_handle_(account: HexString, $c: AptosDataCache, $p: TypeTag[]): Promise<Event.EventHandle>;
export declare function offer_signer_capability_(account: HexString, signer_capability_sig_bytes: U8[], account_scheme: U8, account_public_key_bytes: U8[], recipient_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function register_coin_(account_addr: HexString, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function revoke_signer_capability_(account: HexString, to_be_revoked_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function rotate_authentication_key_(account: HexString, from_scheme: U8, from_public_key_bytes: U8[], to_scheme: U8, to_public_key_bytes: U8[], cap_rotate_key: U8[], cap_update_table: U8[], $c: AptosDataCache): Promise<void>;
...
export declare function rotate_authentication_key_internal_(account: HexString, new_auth_key: U8[], $c: AptosDataCache): Promise<void>;
export declare function verify_key_rotation_signature_and_get_auth_key_(scheme: U8, public_key_bytes: U8[], signature: U8[], challenge: RotationProofChallenge, $c: AptosDataCache): Promise<U8[]>;
