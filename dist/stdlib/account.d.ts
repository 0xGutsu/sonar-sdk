...
export declare function verify_key_rotation_signature_and_get_auth_key_(scheme: U8, public_key_bytes: U8[], signature: U8[], challenge: RotationProofChallenge, $c: AptosDataCache): U8[];
...
export declare class App {
    ...
    loadAccount(owner: HexString, loadFull?: boolean): Promise<Account>;
    ...
    loadOriginatingAddress(owner: HexString, loadFull?: boolean): Promise<OriginatingAddress>;
    ...
    offer_signer_capability(_account: AptosAccount, signer_capability_sig_bytes: U8[], account_scheme: U8, account_public_key_bytes: U8[], recipient_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    revoke_signer_capability(_account: AptosAccount, to_be_revoked_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    rotate_authentication_key(_account: AptosAccount, from_scheme: U8, from_public_key_bytes: U8[], to_scheme: U8, to_public_key_bytes: U8[], cap_rotate_key: U8[], cap_update_table: U8[], _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
