...
export declare function add_approved_script_hash_(proposal_id: U64, $c: AptosDataCache): Promise<void>;
export declare function add_approved_script_hash_script_(proposal_id: U64, $c: AptosDataCache): Promise<void>;
...
export declare function create_proposal_(proposer: HexString, stake_pool: HexString, execution_hash: U8[], metadata_location: U8[], metadata_hash: U8[], $c: AptosDataCache): Promise<void>;
...
export declare function create_proposal_metadata_(metadata_location: U8[], metadata_hash: U8[], $c: AptosDataCache): Promise<Simple_map.SimpleMap>;
export declare function get_min_voting_threshold_($c: AptosDataCache): Promise<U128>;
export declare function get_required_proposer_stake_($c: AptosDataCache): Promise<U64>;
export declare function get_signer_(signer_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function get_signer_testnet_only_(core_resources: HexString, signer_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function get_voting_duration_secs_($c: AptosDataCache): Promise<U64>;
export declare function get_voting_power_(pool_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function initialize_(aptos_framework: HexString, min_voting_threshold: U128, required_proposer_stake: U64, voting_duration_secs: U64, $c: AptosDataCache): Promise<void>;
export declare function initialize_for_verification_(aptos_framework: HexString, min_voting_threshold: U128, required_proposer_stake: U64, voting_duration_secs: U64, $c: AptosDataCache): Promise<void>;
export declare function reconfigure_(aptos_framework: HexString, $c: AptosDataCache): Promise<void>;
export declare function remove_approved_hash_(proposal_id: U64, $c: AptosDataCache): Promise<void>;
export declare function resolve_(proposal_id: U64, signer_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function store_signer_cap_(aptos_framework: HexString, signer_address: HexString, signer_cap: Account.SignerCapability, $c: AptosDataCache): Promise<void>;
export declare function update_governance_config_(aptos_framework: HexString, min_voting_threshold: U128, required_proposer_stake: U64, voting_duration_secs: U64, $c: AptosDataCache): Promise<void>;
export declare function vote_(voter: HexString, stake_pool: HexString, proposal_id: U64, should_pass: boolean, $c: AptosDataCache): Promise<void>;
