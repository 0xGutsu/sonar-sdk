...
export declare class App {
    ...
    loadApprovedExecutionHashes(owner: HexString, loadFull?: boolean): Promise<ApprovedExecutionHashes>;
    get CreateProposalEvent(): typeof CreateProposalEvent;
    get GovernanceConfig(): typeof GovernanceConfig;
    loadGovernanceConfig(owner: HexString, loadFull?: boolean): Promise<GovernanceConfig>;
    get GovernanceEvents(): typeof GovernanceEvents;
    loadGovernanceEvents(owner: HexString, loadFull?: boolean): Promise<GovernanceEvents>;
    get GovernanceResponsbility(): typeof GovernanceResponsbility;
    loadGovernanceResponsbility(owner: HexString, loadFull?: boolean): Promise<GovernanceResponsbility>;
    ...
    loadVotingRecords(owner: HexString, loadFull?: boolean): Promise<VotingRecords>;
    ...
    add_approved_script_hash_script(_account: AptosAccount, proposal_id: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    create_proposal(_account: AptosAccount, stake_pool: HexString, execution_hash: U8[], metadata_location: U8[], metadata_hash: U8[], _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    vote(_account: AptosAccount, stake_pool: HexString, proposal_id: U64, should_pass: boolean, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
