...
function borrow_(t, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!(yield is_some_(t, $c, [$p[0]]))) {
            throw $.abortCode($.copy(exports.EOPTION_NOT_SET));
        }
        return yield Vector.borrow_((t).vec, (0, move_to_ts_1.u64)("0"), $c, [$p[0]]);
    });
}
...
function borrow_mut_(t, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield Vector.borrow_mut_((t).vec, (0, move_to_ts_1.u64)("0"), $c, [$p[0]]);
    });
}
...
function borrow_with_default_(t, default_ref, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        let temp$1, vec_ref;
        vec_ref = (t).vec;
        if (yield Vector.is_empty_(vec_ref, $c, [$p[0]])) {
            temp$1 = default_ref;
        }
        else {
            temp$1 = yield Vector.borrow_(vec_ref, (0, move_to_ts_1.u64)("0"), $c, [$p[0]]);
        }
        return temp$1;
    });
}
...
function contains_(t, e_ref, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Vector.contains_((t).vec, e_ref, $c, [$p[0]]);
    });
}
exports.contains_ = contains_;
function destroy_none_(t, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!(yield is_none_(t, $c, [$p[0]]))) {
            throw $.abortCode($.copy(exports.EOPTION_IS_SET));
        }
        let { vec: vec } = t;
        return yield Vector.destroy_empty_(vec, $c, [$p[0]]);
    });
}
...
function destroy_some_(t, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let { vec: vec } = t;
        elem = yield Vector.pop_back_(vec, $c, [$p[0]]);
        yield Vector.destroy_empty_(vec, $c, [$p[0]]);
        return elem;
    });
}
...
function destroy_with_default_(t, default__, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        let temp$1;
        let { vec: vec } = t;
        if (yield Vector.is_empty_(vec, $c, [$p[0]])) {
            temp$1 = default__;
        }
        else {
            temp$1 = yield Vector.pop_back_(vec, $c, [$p[0]]);
        }
        return temp$1;
    });
}
...
function extract_(t, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield Vector.pop_back_((t).vec, $c, [$p[0]]);
    });
}
...
function fill_(t, e, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vec_ref = (t).vec;
        if (yield Vector.is_empty_(vec_ref, $c, [$p[0]])) {
            yield Vector.push_back_(vec_ref, e, $c, [$p[0]]);
        }
        else {
            throw $.abortCode($.copy(exports.EOPTION_IS_SET));
        }
...
function get_with_default_(t, default__, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (yield Vector.is_empty_(vec_ref, $c, [$p[0]])) {
            ...
            temp$1 = $.copy(yield Vector.borrow_(vec_ref, (0, move_to_ts_1.u64)("0"), $c, [$p[0]]));
        }
        return temp$1;
    });
}
...
function is_none_(t, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Vector.is_empty_((t).vec, $c, [$p[0]]);
    });
}
...
function none_($c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Option({ vec: yield Vector.empty_($c, [$p[0]]) }, new move_to_ts_2.SimpleStructTag(Option, [$p[0]]));
    });
}
exports.none_ = none_;
function some_(e, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Option({ vec: yield Vector.singleton_(e, $c, [$p[0]]) }, new move_to_ts_2.SimpleStructTag(Option, [$p[0]]));
    });
}
exports.some_ = some_;
function swap_(t, e, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vec_ref = (t).vec;
        old_value = yield Vector.pop_back_(vec_ref, $c, [$p[0]]);
        yield Vector.push_back_(vec_ref, e, $c, [$p[0]]);
        return old_value;
    });
}
...
function swap_or_fill_(t, e, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vec_ref = (t).vec;
        if (yield Vector.is_empty_(vec_ref, $c, [$p[0]])) {
            temp$1 = yield none_($c, [$p[0]]);
        }
        else {
            temp$1 = yield some_(yield Vector.pop_back_(vec_ref, $c, [$p[0]]), $c, [$p[0]]);
        }
        old_value = temp$1;
        yield Vector.push_back_(vec_ref, e, $c, [$p[0]]);
        return old_value;
