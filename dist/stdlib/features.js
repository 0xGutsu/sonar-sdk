...
function change_feature_flags_(framework, enable, disable, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!((yield Signer.address_of_(framework, $c)).hex() === (new aptos_1.HexString("0x1")).hex())) {
            throw $.abortCode(yield Error.permission_denied_($.copy(exports.EFRAMEWORK_SIGNER_NEEDED), $c));
        }
        if (!(yield $c.exists_async(new move_to_ts_2.SimpleStructTag(Features), new aptos_1.HexString("0x1")))) {
            yield $c.move_to_async(new move_to_ts_2.SimpleStructTag(Features), framework, new Features({ features: [] }, new move_to_ts_2.SimpleStructTag(Features)));
        }
        else {
        }
        features = (yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(Features), new aptos_1.HexString("0x1"))).features;
        i = (0, move_to_ts_1.u64)("0");
        n = yield Vector.length_(enable, $c, [move_to_ts_2.AtomicTypeTag.U64]);
        while (($.copy(i)).lt($.copy(n))) {
            {
                yield set_(features, $.copy(yield Vector.borrow_(enable, $.copy(i), $c, [move_to_ts_2.AtomicTypeTag.U64])), true, $c);
                i = ($.copy(i)).add((0, move_to_ts_1.u64)("1"));
            }
        }
        i__1 = (0, move_to_ts_1.u64)("0");
        n__2 = yield Vector.length_(disable, $c, [move_to_ts_2.AtomicTypeTag.U64]);
        while (($.copy(i__1)).lt($.copy(n__2))) {
            {
                yield set_(features, $.copy(yield Vector.borrow_(disable, $.copy(i__1), $c, [move_to_ts_2.AtomicTypeTag.U64])), false, $c);
...
function code_dependency_check_enabled_($c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield is_enabled_($.copy(exports.CODE_DEPENDENCY_CHECK), $c);
    });
}
...
function contains_(features, feature, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (($.copy(byte_index)).lt(yield Vector.length_(features, $c, [move_to_ts_2.AtomicTypeTag.U8]))) {
            temp$1 = (($.copy(yield Vector.borrow_(features, $.copy(byte_index), $c, [move_to_ts_2.AtomicTypeTag.U8]))).and($.copy(bit_mask))).neq((0, move_to_ts_1.u8)("0"));
        }
        else {
            temp$1 = false;
        }
...
function is_enabled_(feature, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        let temp$1;
        if (yield $c.exists_async(new move_to_ts_2.SimpleStructTag(Features), new aptos_1.HexString("0x1"))) {
            temp$1 = yield contains_((yield $c.borrow_global_async(new move_to_ts_2.SimpleStructTag(Features), new aptos_1.HexString("0x1"))).features, $.copy(feature), $c);
        }
        else {
            temp$1 = false;
        }
...
function set_(features, feature, include, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        byte_index = ($.copy(feature)).div((0, move_to_ts_1.u64)("8"));
        bit_mask = ((0, move_to_ts_1.u8)("1")).shl((0, move_to_ts_1.u8)(($.copy(feature)).mod((0, move_to_ts_1.u64)("8"))));
        while ((yield Vector.length_(features, $c, [move_to_ts_2.AtomicTypeTag.U8])).le($.copy(byte_index))) {
            {
                yield Vector.push_back_(features, (0, move_to_ts_1.u8)("0"), $c, [move_to_ts_2.AtomicTypeTag.U8]);
            }
        }
        entry = yield Vector.borrow_mut_(features, $.copy(byte_index), $c, [move_to_ts_2.AtomicTypeTag.U8]);
        if (include) {
...
function treat_friend_as_private_($c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield is_enabled_($.copy(exports.TREAT_FRIEND_AS_PRIVATE), $c);
    });
}
