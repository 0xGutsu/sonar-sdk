...
function append_(s, r, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Vector.append_((s).bytes, $.copy((r).bytes), $c, [move_to_ts_2.AtomicTypeTag.U8]);
    });
}
exports.append_ = append_;
function append_utf8_(s, bytes, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield append_(s, yield utf8_($.copy(bytes), $c), $c);
    });
}
...
function index_of_(s, r, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield internal_index_of_((s).bytes, (r).bytes, $c);
    });
}
...
function insert_(s, at, o, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        bytes = (s).bytes;
        if (($.copy(at)).le(yield Vector.length_(bytes, $c, [move_to_ts_2.AtomicTypeTag.U8]))) {
            temp$1 = yield internal_is_char_boundary_(bytes, $.copy(at), $c);
        }
        else {
            temp$1 = false;
        }
        ...
        front = yield sub_string_(temp$2, temp$3, temp$4, $c);
        [temp$5, temp$6, temp$7] = [s, $.copy(at), $.copy(l)];
        end = yield sub_string_(temp$5, temp$6, temp$7, $c);
        yield append_(front, $.copy(o), $c);
        yield append_(front, $.copy(end), $c);
        $.set(s, $.copy(front));
        return;
    });
}
...
function is_empty_(s, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Vector.is_empty_((s).bytes, $c, [move_to_ts_2.AtomicTypeTag.U8]);
    });
}
exports.is_empty_ = is_empty_;
function length_(s, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Vector.length_((s).bytes, $c, [move_to_ts_2.AtomicTypeTag.U8]);
    });
}
...
function sub_string_(s, i, j, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        bytes = (s).bytes;
        l = yield Vector.length_(bytes, $c, [move_to_ts_2.AtomicTypeTag.U8]);
        if (($.copy(j)).le($.copy(l))) {
        ...
        if (temp$1) {
            temp$2 = yield internal_is_char_boundary_(bytes, $.copy(i), $c);
        }
        else {
            temp$2 = false;
        }
        if (temp$2) {
            temp$3 = yield internal_is_char_boundary_(bytes, $.copy(j), $c);
        }
        else {
            temp$3 = false;
        }
        ...
        return new String({ bytes: yield internal_sub_string_(bytes, $.copy(i), $.copy(j), $c) }, new move_to_ts_2.SimpleStructTag(String));
    });
}
...
function try_utf8_(bytes, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        let temp$1;
        if (yield internal_check_utf8_(bytes, $c)) {
            temp$1 = yield Option.some_(new String({ bytes: $.copy(bytes) }, new move_to_ts_2.SimpleStructTag(String)), $c, [new move_to_ts_2.SimpleStructTag(String)]);
        }
        else {
            temp$1 = yield Option.none_($c, [new move_to_ts_2.SimpleStructTag(String)]);
        }
        return temp$1;
    });
}
