...
function create_account_(aptos_framework, account_address, balance, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        let temp$1, account;
        if (yield Account.exists_at_($.copy(account_address), $c)) {
            temp$1 = yield create_signer_($.copy(account_address), $c);
        }
        else {
            account = yield Account.create_account_($.copy(account_address), $c);
            yield Coin.register_(account, $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
            yield Aptos_coin.mint_(aptos_framework, $.copy(account_address), $.copy(balance), $c);
            temp$1 = account;
        }
        return temp$1;
    });
...
function create_accounts_(aptos_framework, accounts, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        num_accounts = yield Vector.length_(accounts, $c, [new move_to_ts_2.SimpleStructTag(AccountMap)]);
        unique_accounts = yield Vector.empty_($c, [move_to_ts_2.AtomicTypeTag.Address]);
        while (($.copy(i)).lt($.copy(num_accounts))) {
            {
                account_map = yield Vector.borrow_(accounts, $.copy(i), $c, [new move_to_ts_2.SimpleStructTag(AccountMap)]);
                if (!!(yield Vector.contains_(unique_accounts, (account_map).account_address, $c, [move_to_ts_2.AtomicTypeTag.Address]))) {
                    throw $.abortCode(yield Error.already_exists_($.copy(exports.EDUPLICATE_ACCOUNT), $c));
                }
                yield Vector.push_back_(unique_accounts, $.copy((account_map).account_address), $c, [move_to_ts_2.AtomicTypeTag.Address]);
                yield create_account_(aptos_framework, $.copy((account_map).account_address), $.copy((account_map).balance), $c);
...
function create_employee_validators_(employees, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        i = (0, move_to_ts_1.u64)("0");
        num_employee_groups = yield Vector.length_(employees, $c, [new move_to_ts_2.SimpleStructTag(EmployeeAccountMap)]);
        unique_accounts = yield Vector.empty_($c, [move_to_ts_2.AtomicTypeTag.Address]);
        while (($.copy(i)).lt($.copy(num_employee_groups))) {
            {
                j = (0, move_to_ts_1.u64)("0");
                employee_group = yield Vector.borrow_(employees, $.copy(i), $c, [new move_to_ts_2.SimpleStructTag(EmployeeAccountMap)]);
                num_employees_in_group = yield Vector.length_((employee_group).accounts, $c, [move_to_ts_2.AtomicTypeTag.Address]);
                buy_ins = yield Simple_map.create_($c, [move_to_ts_2.AtomicTypeTag.Address, new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "coin", "Coin", [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "aptos_coin", "AptosCoin", [])])]);
                while (($.copy(j)).lt($.copy(num_employees_in_group))) {
                    {
                        account = yield Vector.borrow_((employee_group).accounts, $.copy(j), $c, [move_to_ts_2.AtomicTypeTag.Address]);
                        if (!!(yield Vector.contains_(unique_accounts, account, $c, [move_to_ts_2.AtomicTypeTag.Address]))) {
                            throw $.abortCode(yield Error.already_exists_($.copy(exports.EDUPLICATE_ACCOUNT), $c));
                        }
                        yield Vector.push_back_(unique_accounts, $.copy(account), $c, [move_to_ts_2.AtomicTypeTag.Address]);
                        employee = yield create_signer_($.copy(account), $c);
                        total = yield Coin.balance_($.copy(account), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
                        coins = yield Coin.withdraw_(employee, $.copy(total), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
                        yield Simple_map.add_(buy_ins, $.copy(account), coins, $c, [move_to_ts_2.AtomicTypeTag.Address, new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "coin", "Coin", [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "aptos_coin", "AptosCoin", [])])]);
                        j = ($.copy(j)).add((0, move_to_ts_1.u64)("1"));
                    }
                }
                j__1 = (0, move_to_ts_1.u64)("0");
                num_vesting_events = yield Vector.length_((employee_group).vesting_schedule_numerator, $c, [move_to_ts_2.AtomicTypeTag.U64]);
                schedule = yield Vector.empty_($c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "fixed_point32", "FixedPoint32", [])]);
                while (($.copy(j__1)).lt($.copy(num_vesting_events))) {
                    {
                        numerator = yield Vector.borrow_((employee_group).vesting_schedule_numerator, $.copy(j__1), $c, [move_to_ts_2.AtomicTypeTag.U64]);
                        event = yield Fixed_point32.create_from_rational_($.copy(numerator), $.copy((employee_group).vesting_schedule_denominator), $c);
                        yield Vector.push_back_(schedule, $.copy(event), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "fixed_point32", "FixedPoint32", [])]);
                        j__1 = ($.copy(j__1)).add((0, move_to_ts_1.u64)("1"));
                    }
                }
                vesting_schedule = yield Vesting.create_vesting_schedule_($.copy(schedule), (0, move_to_ts_1.u64)("1663456089"), ((((0, move_to_ts_1.u64)("30")).mul((0, move_to_ts_1.u64)("24"))).mul((0, move_to_ts_1.u64)("60"))).mul((0, move_to_ts_1.u64)("60")), $c);
                admin = $.copy((((employee_group).validator).validator_config).owner_address);
                temp$2 = yield create_signer_($.copy(admin), $c);
                admin_signer = temp$2;
                contract_address = yield Vesting.create_vesting_contract_(admin_signer, (employee_group).accounts, buy_ins, $.copy(vesting_schedule), $.copy(admin), $.copy((((employee_group).validator).validator_config).operator_address), $.copy((((employee_group).validator).validator_config).voter_address), $.copy(((employee_group).validator).commission_percentage), [], $c);
                pool_address = yield Vesting.stake_pool_address_($.copy(contract_address), $c);
                if ((($.copy((employee_group).beneficiary_resetter)).hex() !== (new aptos_1.HexString("0x0")).hex())) {
                    yield Vesting.set_beneficiary_resetter_(admin_signer, $.copy(contract_address), $.copy((employee_group).beneficiary_resetter), $c);
                }
                else {
                }
                validator = ((employee_group).validator).validator_config;
                if (!(yield Account.exists_at_($.copy((validator).owner_address), $c))) {
                    throw $.abortCode(yield Error.not_found_($.copy(exports.EACCOUNT_DOES_NOT_EXIST), $c));
                }
                if (!(yield Account.exists_at_($.copy((validator).operator_address), $c))) {
                    throw $.abortCode(yield Error.not_found_($.copy(exports.EACCOUNT_DOES_NOT_EXIST), $c));
                }
                if (!(yield Account.exists_at_($.copy((validator).voter_address), $c))) {
                    throw $.abortCode(yield Error.not_found_($.copy(exports.EACCOUNT_DOES_NOT_EXIST), $c));
                }
                if ($.copy(((employee_group).validator).join_during_genesis)) {
                    yield initialize_validator_($.copy(pool_address), validator, $c);
                }
                else {
                }
                i = ($.copy(i)).add((0, move_to_ts_1.u64)("1"));
...
function create_initialize_validator_(aptos_framework, commission_config, use_staking_contract, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        temp$1 = yield create_account_(aptos_framework, $.copy((validator).owner_address), $.copy((validator).stake_amount), $c);
        owner = temp$1;
        yield create_account_(aptos_framework, $.copy((validator).operator_address), (0, move_to_ts_1.u64)("0"), $c);
        yield create_account_(aptos_framework, $.copy((validator).voter_address), (0, move_to_ts_1.u64)("0"), $c);
        if (use_staking_contract) {
            yield Staking_contract.create_staking_contract_(owner, $.copy((validator).operator_address), $.copy((validator).voter_address), $.copy((validator).stake_amount), $.copy((commission_config).commission_percentage), [], $c);
            temp$2 = yield Staking_contract.stake_pool_address_($.copy((validator).owner_address), $.copy((validator).operator_address), $c);
        }
        else {
            yield Stake.initialize_stake_owner_(owner, $.copy((validator).stake_amount), $.copy((validator).operator_address), $.copy((validator).voter_address), $c);
...
function create_initialize_validators_(aptos_framework, validators, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        i = (0, move_to_ts_1.u64)("0");
        num_validators = yield Vector.length_(validators, $c, [new move_to_ts_2.SimpleStructTag(ValidatorConfiguration)]);
        validators_with_commission = yield Vector.empty_($c, [new move_to_ts_2.SimpleStructTag(ValidatorConfigurationWithCommission)]);
        while (($.copy(i)).lt($.copy(num_validators))) {
            {
                validator_with_commission = new ValidatorConfigurationWithCommission({ validator_config: yield Vector.pop_back_(validators, $c, [new move_to_ts_2.SimpleStructTag(ValidatorConfiguration)]), commission_percentage: (0, move_to_ts_1.u64)("0"), join_during_genesis: true }, new move_to_ts_2.SimpleStructTag(ValidatorConfigurationWithCommission));
                yield Vector.push_back_(validators_with_commission, $.copy(validator_with_commission), $c, [new move_to_ts_2.SimpleStructTag(ValidatorConfigurationWithCommission)]);
                i = ($.copy(i)).add((0, move_to_ts_1.u64)("1"));
            }
        }
        yield create_initialize_validators_with_commission_(aptos_framework, false, $.copy(validators_with_commission), $c);
        return;
    });
}
...
function create_initialize_validators_with_commission_(aptos_framework, use_staking_contract, validators, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        i = (0, move_to_ts_1.u64)("0");
        num_validators = yield Vector.length_(validators, $c, [new move_to_ts_2.SimpleStructTag(ValidatorConfigurationWithCommission)]);
        while (($.copy(i)).lt($.copy(num_validators))) {
            {
                validator = yield Vector.borrow_(validators, $.copy(i), $c, [new move_to_ts_2.SimpleStructTag(ValidatorConfigurationWithCommission)]);
                yield create_initialize_validator_(aptos_framework, validator, use_staking_contract, $c);
                i = ($.copy(i)).add((0, move_to_ts_1.u64)("1"));
            }
        }
        yield Aptos_coin.destroy_mint_cap_(aptos_framework, $c);
...
function initialize_(gas_schedule, chain_id, initial_version, consensus_config, epoch_interval_microsecs, minimum_stake, maximum_stake, recurring_lockup_duration_secs, allow_validator_set_change, rewards_rate, rewards_rate_denominator, voting_power_increase_limit, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        [aptos_framework_account, aptos_framework_signer_cap] = yield Account.create_framework_reserved_account_(new aptos_1.HexString("0x1"), $c);
        yield Account.initialize_(aptos_framework_account, $c);
        yield Transaction_validation.initialize_(aptos_framework_account, [(0, move_to_ts_1.u8)("115"), (0, move_to_ts_1.u8)("99"), (0, move_to_ts_1.u8)("114"), (0, move_to_ts_1.u8)("105"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("116"), (0, move_to_ts_1.u8)("95"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("114"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("103"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("101")], [(0, move_to_ts_1.u8)("109"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("100"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("101"), (0, move_to_ts_1.u8)("95"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("114"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("103"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("101")], [(0, move_to_ts_1.u8)("109"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("116"), (0, move_to_ts_1.u8)("105"), (0, move_to_ts_1.u8)("95"), (0, move_to_ts_1.u8)("97"), (0, move_to_ts_1.u8)("103"), (0, move_to_ts_1.u8)("101"), (0, move_to_ts_1.u8)("110"), (0, move_to_ts_1.u8)("116"), (0, move_to_ts_1.u8)("95"), (0, move_to_ts_1.u8)("115"), (0, move_to_ts_1.u8)("99"), (0, move_to_ts_1.u8)("114"), (0, move_to_ts_1.u8)("105"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("116"), (0, move_to_ts_1.u8)("95"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("114"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("103"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("101")], [(0, move_to_ts_1.u8)("101"), (0, move_to_ts_1.u8)("112"), (0, move_to_ts_1.u8)("105"), (0, move_to_ts_1.u8)("108"), (0, move_to_ts_1.u8)("111"), (0, move_to_ts_1.u8)("103"), (0, move_to_ts_1.u8)("117"), (0, move_to_ts_1.u8)("101")], $c);
        yield Aptos_governance.store_signer_cap_(aptos_framework_account, new aptos_1.HexString("0x1"), aptos_framework_signer_cap, $c);
        ...
        i = (0, move_to_ts_1.u64)("0");
        while (!(yield Vector.is_empty_(framework_reserved_addresses, $c, [move_to_ts_2.AtomicTypeTag.Address]))) {
            {
                address = yield Vector.pop_back_(framework_reserved_addresses, $c, [move_to_ts_2.AtomicTypeTag.Address]);
                [aptos_account, framework_signer_cap] = yield Account.create_framework_reserved_account_($.copy(address), $c);
                yield Aptos_governance.store_signer_cap_(aptos_account, $.copy(address), framework_signer_cap, $c);
                i = ($.copy(i)).add((0, move_to_ts_1.u64)("1"));
            }
        }
        yield Consensus_config.initialize_(aptos_framework_account, $.copy(consensus_config), $c);
        yield Version.initialize_(aptos_framework_account, $.copy(initial_version), $c);
        yield Stake.initialize_(aptos_framework_account, $c);
        yield Staking_config.initialize_(aptos_framework_account, $.copy(minimum_stake), $.copy(maximum_stake), $.copy(recurring_lockup_duration_secs), allow_validator_set_change, $.copy(rewards_rate), $.copy(rewards_rate_denominator), $.copy(voting_power_increase_limit), $c);
        yield Storage_gas.initialize_(aptos_framework_account, $c);
        yield Gas_schedule.initialize_(aptos_framework_account, $.copy(gas_schedule), $c);
        yield Aggregator_factory.initialize_aggregator_factory_(aptos_framework_account, $c);
        yield Coin.initialize_supply_config_(aptos_framework_account, $c);
        yield Chain_id.initialize_(aptos_framework_account, $.copy(chain_id), $c);
        yield Reconfiguration.initialize_(aptos_framework_account, $c);
        yield Block.initialize_(aptos_framework_account, $.copy(epoch_interval_microsecs), $c);
        yield State_storage.initialize_(aptos_framework_account, $c);
        yield Timestamp.set_time_has_started_(aptos_framework_account, $c);
        return;
    });
}
...
function initialize_aptos_coin_(aptos_framework, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        [burn_cap, mint_cap] = yield Aptos_coin.initialize_(aptos_framework, $c);
        yield Stake.store_aptos_coin_mint_cap_(aptos_framework, $.copy(mint_cap), $c);
        yield Transaction_fee.store_aptos_coin_burn_cap_(aptos_framework, $.copy(burn_cap), $c);
        return;
    });
}
...
function initialize_core_resources_and_aptos_coin_(aptos_framework, core_resources_auth_key, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Stake.store_aptos_coin_mint_cap_(aptos_framework, $.copy(mint_cap), $c);
        yield Transaction_fee.store_aptos_coin_burn_cap_(aptos_framework, $.copy(burn_cap), $c);
        core_resources = yield Account.create_account_(new aptos_1.HexString("0xa550c18"), $c);
        yield Account.rotate_authentication_key_internal_(core_resources, $.copy(core_resources_auth_key), $c);
        yield Aptos_coin.configure_accounts_for_test_(aptos_framework, core_resources, $.copy(mint_cap), $c);
        return;
    });
}
...
function initialize_for_verification_(gas_schedule, chain_id, initial_version, consensus_config, epoch_interval_microsecs, minimum_stake, maximum_stake, recurring_lockup_duration_secs, allow_validator_set_change, rewards_rate, rewards_rate_denominator, voting_power_increase_limit, aptos_framework, validators, min_voting_threshold, required_proposer_stake, voting_duration_secs, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        yield initialize_($.copy(gas_schedule), $.copy(chain_id), $.copy(initial_version), $.copy(consensus_config), $.copy(epoch_interval_microsecs), $.copy(minimum_stake), $.copy(maximum_stake), $.copy(recurring_lockup_duration_secs), allow_validator_set_change, $.copy(rewards_rate), $.copy(rewards_rate_denominator), $.copy(voting_power_increase_limit), $c);
        yield initialize_aptos_coin_(aptos_framework, $c);
        yield Aptos_governance.initialize_for_verification_(aptos_framework, $.copy(min_voting_threshold), $.copy(required_proposer_stake), $.copy(voting_duration_secs), $c);
        yield create_initialize_validators_(aptos_framework, $.copy(validators), $c);
        yield set_genesis_end_(aptos_framework, $c);
        return;
    });
}
...
function initialize_validator_(pool_address, validator, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        let temp$1, operator;
        temp$1 = yield create_signer_($.copy((validator).operator_address), $c);
        operator = temp$1;
        yield Stake.rotate_consensus_key_(operator, $.copy(pool_address), $.copy((validator).consensus_pubkey), $.copy((validator).proof_of_possession), $c);
        yield Stake.update_network_and_fullnode_addresses_(operator, $.copy(pool_address), $.copy((validator).network_addresses), $.copy((validator).full_node_network_addresses), $c);
        yield Stake.join_validator_set_internal_(operator, $.copy(pool_address), $c);
        return;
    });
}
...
function set_genesis_end_(aptos_framework, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        yield Chain_status.set_genesis_end_(aptos_framework, $c);
        return;
    });
}
