    ...
    while (($.copy(i)).lt($.copy(num_employee_groups))) {
        {
            ...
            vesting_schedule = Vesting.create_vesting_schedule_($.copy(schedule), (0, move_to_ts_1.u64)("1663456089"), ((((0, move_to_ts_1.u64)("30")).mul((0, move_to_ts_1.u64)("24"))).mul((0, move_to_ts_1.u64)("60"))).mul((0, move_to_ts_1.u64)("60")), $c);
