...
function add_approved_script_hash_(proposal_id, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        approved_hashes = yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(ApprovedExecutionHashes), new aptos_1.HexString("0x1"));
        if (yield Simple_map.contains_key_((approved_hashes).hashes, proposal_id, $c, [move_to_ts_2.AtomicTypeTag.U64, new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)])) {
            return;
        }
        else {
        }
        proposal_state = yield Voting.get_proposal_state_(new aptos_1.HexString("0x1"), $.copy(proposal_id), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        if (!($.copy(proposal_state)).eq(($.copy(exports.PROPOSAL_STATE_SUCCEEDED)))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EPROPOSAL_NOT_RESOLVABLE_YET), $c));
        }
        execution_hash = yield Voting.get_execution_hash_(new aptos_1.HexString("0x1"), $.copy(proposal_id), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        yield Simple_map.add_((approved_hashes).hashes, $.copy(proposal_id), $.copy(execution_hash), $c, [move_to_ts_2.AtomicTypeTag.U64, new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)]);
        return;
    });
}
...
function add_approved_script_hash_script_(proposal_id, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield add_approved_script_hash_($.copy(proposal_id), $c);
    });
}
...
function create_proposal_(proposer, stake_pool, execution_hash, metadata_location, metadata_hash, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        proposer_address = yield Signer.address_of_(proposer, $c);
        if (!((yield Stake.get_delegated_voter_($.copy(stake_pool), $c)).hex() === ($.copy(proposer_address)).hex())) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.ENOT_DELEGATED_VOTER), $c));
        }
        governance_config = yield $c.borrow_global_async(new move_to_ts_2.SimpleStructTag(GovernanceConfig), new aptos_1.HexString("0x1"));
        stake_balance = yield get_voting_power_($.copy(stake_pool), $c);
        if (!($.copy(stake_balance)).ge($.copy((governance_config).required_proposer_stake))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EINSUFFICIENT_PROPOSER_STAKE), $c));
        }
        current_time = yield Timestamp.now_seconds_($c);
        proposal_expiration = ($.copy(current_time)).add($.copy((governance_config).voting_duration_secs));
        if (!(yield Stake.get_lockup_secs_($.copy(stake_pool), $c)).ge($.copy(proposal_expiration))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EINSUFFICIENT_STAKE_LOCKUP), $c));
        }
        proposal_metadata = yield create_proposal_metadata_($.copy(metadata_location), $.copy(metadata_hash), $c);
        total_voting_token_supply = yield Coin.supply_($c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
        early_resolution_vote_threshold = yield Option.none_($c, [move_to_ts_2.AtomicTypeTag.U128]);
        if (yield Option.is_some_(total_voting_token_supply, $c, [move_to_ts_2.AtomicTypeTag.U128])) {
            total_supply = $.copy(yield Option.borrow_(total_voting_token_supply, $c, [move_to_ts_2.AtomicTypeTag.U128]));
            early_resolution_vote_threshold = yield Option.some_((($.copy(total_supply)).div((0, move_to_ts_1.u128)("2"))).add((0, move_to_ts_1.u128)("1")), $c, [move_to_ts_2.AtomicTypeTag.U128]);
        }
        else {
        }
        proposal_id = yield Voting.create_proposal_($.copy(proposer_address), new aptos_1.HexString("0x1"), yield Governance_proposal.create_proposal_($c), $.copy(execution_hash), $.copy((governance_config).min_voting_threshold), $.copy(proposal_expiration), $.copy(early_resolution_vote_threshold), $.copy(proposal_metadata), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        events = yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(GovernanceEvents), new aptos_1.HexString("0x1"));
        ...
        yield Event.emit_event_(temp$6, new CreateProposalEvent({ proposer: temp$2, stake_pool: temp$3, proposal_id: temp$1, execution_hash: temp$4, proposal_metadata: temp$5 }, new move_to_ts_2.SimpleStructTag(CreateProposalEvent)), $c, [new move_to_ts_2.SimpleStructTag(CreateProposalEvent)]);
        return;
    });
}
...
function create_proposal_metadata_(metadata_location, metadata_hash, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        temp$1 = yield String.utf8_($.copy(metadata_location), $c);
        if (!(yield String.length_(temp$1, $c)).le((0, move_to_ts_1.u64)("256"))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EMETADATA_LOCATION_TOO_LONG), $c));
        }
        temp$2 = yield String.utf8_($.copy(metadata_hash), $c);
        if (!(yield String.length_(temp$2, $c)).le((0, move_to_ts_1.u64)("256"))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EMETADATA_HASH_TOO_LONG), $c));
        }
        metadata = yield Simple_map.create_($c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "string", "String", []), new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)]);
        yield Simple_map.add_(metadata, yield String.utf8_($.copy(exports.METADATA_LOCATION_KEY), $c), $.copy(metadata_location), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "string", "String", []), new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)]);
        yield Simple_map.add_(metadata, yield String.utf8_($.copy(exports.METADATA_HASH_KEY), $c), $.copy(metadata_hash), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "string", "String", []), new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)]);
...
function get_min_voting_threshold_($c) {
    return __awaiter(this, void 0, void 0, function* () {
        return $.copy((yield $c.borrow_global_async(new move_to_ts_2.SimpleStructTag(GovernanceConfig), new aptos_1.HexString("0x1"))).min_voting_threshold);
    });
}
exports.get_min_voting_threshold_ = get_min_voting_threshold_;
function get_required_proposer_stake_($c) {
    return __awaiter(this, void 0, void 0, function* () {
        return $.copy((yield $c.borrow_global_async(new move_to_ts_2.SimpleStructTag(GovernanceConfig), new aptos_1.HexString("0x1"))).required_proposer_stake);
    });
}
...
function get_signer_(signer_address, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        governance_responsibility = yield $c.borrow_global_async(new move_to_ts_2.SimpleStructTag(GovernanceResponsbility), new aptos_1.HexString("0x1"));
        signer_cap = yield Simple_map.borrow_((governance_responsibility).signer_caps, signer_address, $c, [move_to_ts_2.AtomicTypeTag.Address, new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "account", "SignerCapability", [])]);
        return yield Account.create_signer_with_capability_(signer_cap, $c);
    });
}
...
function get_signer_testnet_only_(core_resources, signer_address, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield Aptos_coin.has_mint_capability_(core_resources, $c))) {
            throw $.abortCode(yield Error.unauthenticated_($.copy(exports.EUNAUTHORIZED), $c));
        }
        return yield get_signer_($.copy(signer_address), $c);
    });
}
exports.get_signer_testnet_only_ = get_signer_testnet_only_;
function get_voting_duration_secs_($c) {
    return __awaiter(this, void 0, void 0, function* () {
        return $.copy((yield $c.borrow_global_async(new move_to_ts_2.SimpleStructTag(GovernanceConfig), new aptos_1.HexString("0x1"))).voting_duration_secs);
    });
}
...
function get_voting_power_(pool_address, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        allow_validator_set_change = yield Staking_config.get_allow_validator_set_change_(temp$1, $c);
        if (allow_validator_set_change) {
            [active, , pending_active, pending_inactive] = yield Stake.get_stake_($.copy(pool_address), $c);
            temp$2 = (($.copy(active)).add($.copy(pending_active))).add($.copy(pending_inactive));
        }
        else {
            temp$2 = yield Stake.get_current_epoch_voting_power_($.copy(pool_address), $c);
        }
        return temp$2;
    });
}
...
function initialize_(aptos_framework, min_voting_threshold, required_proposer_stake, voting_duration_secs, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Voting.register_(aptos_framework, $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        ...
        yield $c.move_to_async(new move_to_ts_2.SimpleStructTag(GovernanceConfig), temp$4, new GovernanceConfig({ min_voting_threshold: temp$2, required_proposer_stake: temp$3, voting_duration_secs: temp$1 }, new move_to_ts_2.SimpleStructTag(GovernanceConfig)));
        yield $c.move_to_async(new move_to_ts_2.SimpleStructTag(GovernanceEvents), aptos_framework, new GovernanceEvents({ create_proposal_events: yield Account.new_event_handle_(aptos_framework, $c, [new move_to_ts_2.SimpleStructTag(CreateProposalEvent)]), update_config_events: yield Account.new_event_handle_(aptos_framework, $c, [new move_to_ts_2.SimpleStructTag(UpdateConfigEvent)]), vote_events: yield Account.new_event_handle_(aptos_framework, $c, [new move_to_ts_2.SimpleStructTag(VoteEvent)]) }, new move_to_ts_2.SimpleStructTag(GovernanceEvents)));
        yield $c.move_to_async(new move_to_ts_2.SimpleStructTag(VotingRecords), aptos_framework, new VotingRecords({ votes: yield Table.new___($c, [new move_to_ts_2.SimpleStructTag(RecordKey), move_to_ts_2.AtomicTypeTag.Bool]) }, new move_to_ts_2.SimpleStructTag(VotingRecords)));
        return yield $c.move_to_async(new move_to_ts_2.SimpleStructTag(ApprovedExecutionHashes), aptos_framework, new ApprovedExecutionHashes({ hashes: yield Simple_map.create_($c, [move_to_ts_2.AtomicTypeTag.U64, new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)]) }, new move_to_ts_2.SimpleStructTag(ApprovedExecutionHashes)));
    });
}
...
function initialize_for_verification_(aptos_framework, min_voting_threshold, required_proposer_stake, voting_duration_secs, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        yield initialize_(aptos_framework, $.copy(min_voting_threshold), $.copy(required_proposer_stake), $.copy(voting_duration_secs), $c);
        return;
    });
}
...
function remove_approved_hash_(proposal_id, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield Voting.is_resolved_(new aptos_1.HexString("0x1"), $.copy(proposal_id), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EPROPOSAL_NOT_RESOLVED_YET), $c));
        }
        approved_hashes = (yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(ApprovedExecutionHashes), new aptos_1.HexString("0x1"))).hashes;
        [temp$1, temp$2] = [approved_hashes, proposal_id];
        if (yield Simple_map.contains_key_(temp$1, temp$2, $c, [move_to_ts_2.AtomicTypeTag.U64, new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)])) {
            yield Simple_map.remove_(approved_hashes, proposal_id, $c, [move_to_ts_2.AtomicTypeTag.U64, new move_to_ts_2.VectorTag(move_to_ts_2.AtomicTypeTag.U8)]);
        }
        else {
        }
        return;
...
function resolve_(proposal_id, signer_address, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        yield Voting.resolve_(new aptos_1.HexString("0x1"), $.copy(proposal_id), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        yield remove_approved_hash_($.copy(proposal_id), $c);
        return yield get_signer_($.copy(signer_address), $c);
    });
}
...
function store_signer_cap_(aptos_framework, signer_address, signer_cap, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        let signer_caps;
        yield System_addresses.assert_framework_reserved_address_(aptos_framework, $c);
        if (!(yield $c.exists_async(new move_to_ts_2.SimpleStructTag(GovernanceResponsbility), new aptos_1.HexString("0x1")))) {
            yield $c.move_to_async(new move_to_ts_2.SimpleStructTag(GovernanceResponsbility), aptos_framework, new GovernanceResponsbility({ signer_caps: yield Simple_map.create_($c, [move_to_ts_2.AtomicTypeTag.Address, new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "account", "SignerCapability", [])]) }, new move_to_ts_2.SimpleStructTag(GovernanceResponsbility)));
        }
        else {
        }
        signer_caps = (yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(GovernanceResponsbility), new aptos_1.HexString("0x1"))).signer_caps;
        yield Simple_map.add_(signer_caps, $.copy(signer_address), signer_cap, $c, [move_to_ts_2.AtomicTypeTag.Address, new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "account", "SignerCapability", [])]);
        return;
    });
}
...
function update_governance_config_(aptos_framework, min_voting_threshold, required_proposer_stake, voting_duration_secs, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield System_addresses.assert_aptos_framework_(aptos_framework, $c);
        governance_config = yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(GovernanceConfig), new aptos_1.HexString("0x1"));
...
function vote_(voter, stake_pool, proposal_id, should_pass, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        voter_address = yield Signer.address_of_(voter, $c);
        if (!((yield Stake.get_delegated_voter_($.copy(stake_pool), $c)).hex() === ($.copy(voter_address)).hex())) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.ENOT_DELEGATED_VOTER), $c));
        }
        voting_records = yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(VotingRecords), new aptos_1.HexString("0x1"));
        ...
        if (!!(yield Table.contains_((voting_records).votes, $.copy(record_key), $c, [new move_to_ts_2.SimpleStructTag(RecordKey), move_to_ts_2.AtomicTypeTag.Bool]))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EALREADY_VOTED), $c));
        }
        yield Table.add_((voting_records).votes, $.copy(record_key), true, $c, [new move_to_ts_2.SimpleStructTag(RecordKey), move_to_ts_2.AtomicTypeTag.Bool]);
        voting_power = yield get_voting_power_($.copy(stake_pool), $c);
        if (!($.copy(voting_power)).gt((0, move_to_ts_1.u64)("0"))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.ENO_VOTING_POWER), $c));
        }
        proposal_expiration = yield Voting.get_proposal_expiration_secs_(new aptos_1.HexString("0x1"), $.copy(proposal_id), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        if (!(yield Stake.get_lockup_secs_($.copy(stake_pool), $c)).ge($.copy(proposal_expiration))) {
            throw $.abortCode(yield Error.invalid_argument_($.copy(exports.EINSUFFICIENT_STAKE_LOCKUP), $c));
        }
        temp$1 = yield Governance_proposal.create_empty_proposal_($c);
        yield Voting.vote_(temp$1, new aptos_1.HexString("0x1"), $.copy(proposal_id), $.copy(voting_power), should_pass, $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        events = yield $c.borrow_global_mut_async(new move_to_ts_2.SimpleStructTag(GovernanceEvents), new aptos_1.HexString("0x1"));
        yield Event.emit_event_((events).vote_events, new VoteEvent({ proposal_id: $.copy(proposal_id), voter: $.copy(voter_address), stake_pool: $.copy(stake_pool), num_votes: $.copy(voting_power), should_pass: should_pass }, new move_to_ts_2.SimpleStructTag(VoteEvent)), $c, [new move_to_ts_2.SimpleStructTag(VoteEvent)]);
        proposal_state = yield Voting.get_proposal_state_(new aptos_1.HexString("0x1"), $.copy(proposal_id), $c, [new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "governance_proposal", "GovernanceProposal", [])]);
        if (($.copy(proposal_state)).eq(($.copy(exports.PROPOSAL_STATE_SUCCEEDED)))) {
            yield add_approved_script_hash_($.copy(proposal_id), $c);
        }
        else {
        }
        return;
