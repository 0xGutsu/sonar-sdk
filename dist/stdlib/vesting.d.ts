...
export declare function admin_withdraw_(admin: HexString, contract_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function assert_active_vesting_contract_(contract_address: HexString, $c: AptosDataCache): Promise<void>;
export declare function assert_vesting_contract_exists_(contract_address: HexString, $c: AptosDataCache): Promise<void>;
export declare function beneficiary_(vesting_contract_address: HexString, shareholder: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function compute_vested_amount_(vesting_contract: VestingContract, $c: AptosDataCache): Promise<U64>;
export declare function create_vesting_contract_(admin: HexString, shareholders: HexString[], buy_ins: Simple_map.SimpleMap, vesting_schedule: VestingSchedule, withdrawal_address: HexString, operator: HexString, voter: HexString, commission_percentage: U64, contract_creation_seed: U8[], $c: AptosDataCache): Promise<HexString>;
export declare function create_vesting_contract_account_(admin: HexString, contract_creation_seed: U8[], $c: AptosDataCache): Promise<[HexString, Account.SignerCapability]>;
export declare function create_vesting_schedule_(schedule: Fixed_point32.FixedPoint32[], start_timestamp_secs: U64, period_duration: U64, $c: AptosDataCache): Promise<VestingSchedule>;
export declare function distribute_(contract_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function get_beneficiary_(contract: VestingContract, shareholder: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function get_role_holder_(contract_address: HexString, role: String.String, $c: AptosDataCache): Promise<HexString>;
export declare function get_vesting_account_signer_(admin: HexString, contract_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function get_vesting_account_signer_internal_(vesting_contract: VestingContract, $c: AptosDataCache): Promise<HexString>;
export declare function operator_(vesting_contract_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function operator_commission_percentage_(vesting_contract_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function remaining_grant_(vesting_contract_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function reset_beneficiary_(account: HexString, contract_address: HexString, shareholder: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function reset_lockup_(admin: HexString, contract_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function set_beneficiary_(admin: HexString, contract_address: HexString, shareholder: HexString, new_beneficiary: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function set_beneficiary_resetter_(admin: HexString, contract_address: HexString, beneficiary_resetter: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function set_management_role_(admin: HexString, contract_address: HexString, role: String.String, role_holder: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function stake_pool_address_(vesting_contract_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function terminate_vesting_contract_(admin: HexString, contract_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function unlock_rewards_(contract_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function unlock_stake_(vesting_contract: VestingContract, amount: U64, $c: AptosDataCache): Promise<void>;
export declare function update_operator_(admin: HexString, contract_address: HexString, new_operator: HexString, commission_percentage: U64, $c: AptosDataCache): Promise<void>;
...
export declare function update_operator_with_same_commission_(admin: HexString, contract_address: HexString, new_operator: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function update_voter_(admin: HexString, contract_address: HexString, new_voter: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function verify_admin_(admin: HexString, vesting_contract: VestingContract, $c: AptosDataCache): Promise<void>;
export declare function vest_(contract_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function vesting_contracts_(admin: HexString, $c: AptosDataCache): Promise<HexString[]>;
export declare function vesting_start_secs_(vesting_contract_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function voter_(vesting_contract_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function withdraw_stake_(vesting_contract: VestingContract, contract_address: HexString, $c: AptosDataCache): Promise<Coin.Coin>;
