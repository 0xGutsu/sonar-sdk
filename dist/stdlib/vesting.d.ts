...
export declare class App {
    ...
    loadAdminStore(owner: HexString, loadFull?: boolean): Promise<AdminStore>;
    ...
    loadVestingAccountManagement(owner: HexString, loadFull?: boolean): Promise<VestingAccountManagement>;
    get VestingContract(): typeof VestingContract;
    loadVestingContract(owner: HexString, loadFull?: boolean): Promise<VestingContract>;
    ...
    admin_withdraw(_account: AptosAccount, contract_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    distribute(_account: AptosAccount, contract_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    reset_beneficiary(_account: AptosAccount, contract_address: HexString, shareholder: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    reset_lockup(_account: AptosAccount, contract_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_beneficiary(_account: AptosAccount, contract_address: HexString, shareholder: HexString, new_beneficiary: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_beneficiary_resetter(_account: AptosAccount, contract_address: HexString, beneficiary_resetter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_management_role(_account: AptosAccount, contract_address: HexString, role: String.String, role_holder: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    terminate_vesting_contract(_account: AptosAccount, contract_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    unlock_rewards(_account: AptosAccount, contract_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    update_operator(_account: AptosAccount, contract_address: HexString, new_operator: HexString, commission_percentage: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    update_operator_with_same_commission(_account: AptosAccount, contract_address: HexString, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    update_voter(_account: AptosAccount, contract_address: HexString, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    vest(_account: AptosAccount, contract_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
