...
function compare_(left, right, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        left_bytes = yield Bcs.to_bytes_(left, $c, [$p[0]]);
        right_bytes = yield Bcs.to_bytes_(right, $c, [$p[0]]);
        return yield compare_u8_vector_($.copy(left_bytes), $.copy(right_bytes), $c);
    });
}
...
function compare_u8_vector_(left, right, $c) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        left_length = yield Vector.length_(left, $c, [move_to_ts_2.AtomicTypeTag.U8]);
        right_length = yield Vector.length_(right, $c, [move_to_ts_2.AtomicTypeTag.U8]);
        ...
        while (true) {
            ...
            if (!(temp$1))
                break;
            {
                left_byte = $.copy(yield Vector.borrow_(left, $.copy(idx), $c, [move_to_ts_2.AtomicTypeTag.U8]));
                right_byte = $.copy(yield Vector.borrow_(right, $.copy(idx), $c, [move_to_ts_2.AtomicTypeTag.U8]));
