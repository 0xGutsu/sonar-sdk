...
export declare class App {
    ...
    create_account(_account: AptosAccount, auth_key: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    transfer(_account: AptosAccount, to: HexString, amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
