...
export declare function assert_account_exists_(addr: HexString, $c: AptosDataCache): Promise<void>;
export declare function assert_account_is_registered_for_apt_(addr: HexString, $c: AptosDataCache): Promise<void>;
export declare function create_account_(auth_key: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function transfer_(source: HexString, to: HexString, amount: U64, $c: AptosDataCache): Promise<void>;
