...
export declare function change_feature_flags_(framework: HexString, enable: U64[], disable: U64[], $c: AptosDataCache): Promise<void>;
export declare function code_dependency_check_enabled_($c: AptosDataCache): Promise<boolean>;
export declare function contains_(features: U8[], feature: U64, $c: AptosDataCache): Promise<boolean>;
export declare function is_enabled_(feature: U64, $c: AptosDataCache): Promise<boolean>;
export declare function set_(features: U8[], feature: U64, include: boolean, $c: AptosDataCache): Promise<void>;
export declare function treat_friend_as_private_($c: AptosDataCache): Promise<boolean>;
