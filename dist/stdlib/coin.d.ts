...
export declare function allow_supply_upgrades_(aptos_framework: HexString, allowed: boolean, $c: AptosDataCache): Promise<void>;
export declare function balance_(owner: HexString, $c: AptosDataCache, $p: TypeTag[]): Promise<U64>;
export declare function burn_(coin: Coin, _cap: BurnCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function burn_from_(account_addr: HexString, amount: U64, burn_cap: BurnCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function coin_address_($c: AptosDataCache, $p: TypeTag[]): Promise<HexString>;
export declare function decimals_($c: AptosDataCache, $p: TypeTag[]): Promise<U8>;
export declare function deposit_(account_addr: HexString, coin: Coin, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function destroy_burn_cap_(burn_cap: BurnCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function destroy_freeze_cap_(freeze_cap: FreezeCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function destroy_mint_cap_(mint_cap: MintCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function destroy_zero_(zero_coin: Coin, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function extract_(coin: Coin, amount: U64, $c: AptosDataCache, $p: TypeTag[]): Promise<Coin>;
export declare function extract_all_(coin: Coin, $c: AptosDataCache, $p: TypeTag[]): Promise<Coin>;
export declare function freeze_coin_store_(account_addr: HexString, _freeze_cap: FreezeCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function initialize_(account: HexString, name: String.String, symbol: String.String, decimals: U8, monitor_supply: boolean, $c: AptosDataCache, $p: TypeTag[]): Promise<[BurnCapability, FreezeCapability, MintCapability]>;
export declare function initialize_internal_(account: HexString, name: String.String, symbol: String.String, decimals: U8, monitor_supply: boolean, parallelizable: boolean, $c: AptosDataCache, $p: TypeTag[]): Promise<[BurnCapability, FreezeCapability, MintCapability]>;
export declare function initialize_supply_config_(aptos_framework: HexString, $c: AptosDataCache): Promise<void>;
export declare function initialize_with_parallelizable_supply_(account: HexString, name: String.String, symbol: String.String, decimals: U8, monitor_supply: boolean, $c: AptosDataCache, $p: TypeTag[]): Promise<[BurnCapability, FreezeCapability, MintCapability]>;
export declare function is_account_registered_(account_addr: HexString, $c: AptosDataCache, $p: TypeTag[]): Promise<boolean>;
export declare function is_coin_initialized_($c: AptosDataCache, $p: TypeTag[]): Promise<boolean>;
export declare function merge_(dst_coin: Coin, source_coin: Coin, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function mint_(amount: U64, _cap: MintCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<Coin>;
export declare function name_($c: AptosDataCache, $p: TypeTag[]): Promise<String.String>;
export declare function register_(account: HexString, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function supply_($c: AptosDataCache, $p: TypeTag[]): Promise<Option.Option>;
export declare function symbol_($c: AptosDataCache, $p: TypeTag[]): Promise<String.String>;
export declare function transfer_(from: HexString, to: HexString, amount: U64, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
...
export declare function unfreeze_coin_store_(account_addr: HexString, _freeze_cap: FreezeCapability, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function upgrade_supply_(account: HexString, $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
...
export declare function value_(coin: Coin, $c: AptosDataCache, $p: TypeTag[]): Promise<U64>;
export declare function withdraw_(account: HexString, amount: U64, $c: AptosDataCache, $p: TypeTag[]): Promise<Coin>;
export declare function zero_($c: AptosDataCache, $p: TypeTag[]): Promise<Coin>;
