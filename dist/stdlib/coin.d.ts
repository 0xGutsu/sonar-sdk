...
export declare class App {
    ...
    loadCoinInfo(owner: HexString, $p: TypeTag[], /* <CoinType> */ loadFull?: boolean): Promise<CoinInfo>;
    get CoinStore(): typeof CoinStore;
    loadCoinStore(owner: HexString, $p: TypeTag[], /* <CoinType> */ loadFull?: boolean): Promise<CoinStore>;
    ...
    loadSupplyConfig(owner: HexString, loadFull?: boolean): Promise<SupplyConfig>;
    ...
    transfer(_account: AptosAccount, to: HexString, amount: U64, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    upgrade_supply(_account: AptosAccount, $p: TypeTag[], /* <CoinType>*/ _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
