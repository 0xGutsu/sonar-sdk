...
export declare function add_stake_(owner: HexString, amount: U64, $c: AptosDataCache): Promise<void>;
...
export declare function add_stake_with_cap_(owner_cap: OwnerCapability, coins: Coin.Coin, $c: AptosDataCache): Promise<void>;
export declare function append_(v1: any[], v2: any[], $c: AptosDataCache, $p: TypeTag[]): Promise<void>;
export declare function assert_owner_cap_exists_(owner: HexString, $c: AptosDataCache): Promise<void>;
export declare function assert_stake_pool_exists_(pool_address: HexString, $c: AptosDataCache): Promise<void>;
export declare function calculate_rewards_amount_(stake_amount: U64, num_successful_proposals: U64, num_total_proposals: U64, rewards_rate: U64, rewards_rate_denominator: U64, $c: AptosDataCache): Promise<U64>;
export declare function configure_allowed_validators_(aptos_framework: HexString, accounts: HexString[], $c: AptosDataCache): Promise<void>;
export declare function deposit_owner_cap_(owner: HexString, owner_cap: OwnerCapability, $c: AptosDataCache): Promise<void>;
export declare function destroy_owner_cap_(owner_cap: OwnerCapability, $c: AptosDataCache): Promise<void>;
export declare function distribute_rewards_(stake: Coin.Coin, num_successful_proposals: U64, num_total_proposals: U64, rewards_rate: U64, rewards_rate_denominator: U64, $c: AptosDataCache): Promise<U64>;
export declare function extract_owner_cap_(owner: HexString, $c: AptosDataCache): Promise<OwnerCapability>;
export declare function find_validator_(v: ValidatorInfo[], addr: HexString, $c: AptosDataCache): Promise<Option.Option>;
export declare function generate_validator_info_(addr: HexString, stake_pool: StakePool, config: ValidatorConfig, $c: AptosDataCache): Promise<ValidatorInfo>;
export declare function get_current_epoch_proposal_counts_(validator_index: U64, $c: AptosDataCache): Promise<[U64, U64]>;
export declare function get_current_epoch_voting_power_(pool_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function get_delegated_voter_(pool_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function get_lockup_secs_(pool_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function get_next_epoch_voting_power_(stake_pool: StakePool, $c: AptosDataCache): Promise<U64>;
export declare function get_operator_(pool_address: HexString, $c: AptosDataCache): Promise<HexString>;
export declare function get_owned_pool_address_(owner_cap: OwnerCapability, $c: AptosDataCache): Promise<HexString>;
export declare function get_remaining_lockup_secs_(pool_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function get_stake_(pool_address: HexString, $c: AptosDataCache): Promise<[U64, U64, U64, U64]>;
export declare function get_validator_config_(pool_address: HexString, $c: AptosDataCache): Promise<[U8[], U8[], U8[]]>;
export declare function get_validator_index_(pool_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function get_validator_state_(pool_address: HexString, $c: AptosDataCache): Promise<U64>;
export declare function increase_lockup_(owner: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function increase_lockup_with_cap_(owner_cap: OwnerCapability, $c: AptosDataCache): Promise<void>;
export declare function initialize_(aptos_framework: HexString, $c: AptosDataCache): Promise<void>;
export declare function initialize_owner_(owner: HexString, $c: AptosDataCache): Promise<void>;
export declare function initialize_stake_owner_(owner: HexString, initial_stake_amount: U64, operator: HexString, voter: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function initialize_validator_(account: HexString, consensus_pubkey: U8[], proof_of_possession: U8[], network_addresses: U8[], fullnode_addresses: U8[], $c: AptosDataCache): Promise<void>;
...
export declare function is_allowed_(account: HexString, $c: AptosDataCache): Promise<boolean>;
export declare function is_current_epoch_validator_(pool_address: HexString, $c: AptosDataCache): Promise<boolean>;
export declare function join_validator_set_(operator: HexString, pool_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function join_validator_set_internal_(operator: HexString, pool_address: HexString, $c: AptosDataCache): Promise<void>;
export declare function leave_validator_set_(operator: HexString, pool_address: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function on_new_epoch_($c: AptosDataCache): Promise<void>;
export declare function reactivate_stake_(owner: HexString, amount: U64, $c: AptosDataCache): Promise<void>;
...
export declare function reactivate_stake_with_cap_(owner_cap: OwnerCapability, amount: U64, $c: AptosDataCache): Promise<void>;
export declare function remove_validators_(aptos_framework: HexString, validators: HexString[], $c: AptosDataCache): Promise<void>;
export declare function remove_validators_internal_(active_validators: ValidatorInfo[], validators: HexString[], $c: AptosDataCache): Promise<void>;
export declare function rotate_consensus_key_(operator: HexString, pool_address: HexString, new_consensus_pubkey: U8[], proof_of_possession: U8[], $c: AptosDataCache): Promise<void>;
...
export declare function set_delegated_voter_(owner: HexString, new_voter: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function set_delegated_voter_with_cap_(owner_cap: OwnerCapability, new_voter: HexString, $c: AptosDataCache): Promise<void>;
export declare function set_operator_(owner: HexString, new_operator: HexString, $c: AptosDataCache): Promise<void>;
...
export declare function set_operator_with_cap_(owner_cap: OwnerCapability, new_operator: HexString, $c: AptosDataCache): Promise<void>;
export declare function stake_pool_exists_(addr: HexString, $c: AptosDataCache): Promise<boolean>;
export declare function store_aptos_coin_mint_cap_(aptos_framework: HexString, mint_cap: Coin.MintCapability, $c: AptosDataCache): Promise<void>;
export declare function unlock_(owner: HexString, amount: U64, $c: AptosDataCache): Promise<void>;
...
export declare function unlock_with_cap_(amount: U64, owner_cap: OwnerCapability, $c: AptosDataCache): Promise<void>;
export declare function update_network_and_fullnode_addresses_(operator: HexString, pool_address: HexString, new_network_addresses: U8[], new_fullnode_addresses: U8[], $c: AptosDataCache): Promise<void>;
...
export declare function update_performance_statistics_(proposer_index: Option.Option, failed_proposer_indices: U64[], $c: AptosDataCache): Promise<void>;
export declare function update_stake_pool_(validator_perf: ValidatorPerformance, pool_address: HexString, staking_config: Staking_config.StakingConfig, $c: AptosDataCache): Promise<void>;
export declare function update_voting_power_increase_(increase_amount: U64, $c: AptosDataCache): Promise<void>;
export declare function withdraw_(owner: HexString, withdraw_amount: U64, $c: AptosDataCache): Promise<void>;
...
export declare function withdraw_with_cap_(owner_cap: OwnerCapability, withdraw_amount: U64, $c: AptosDataCache): Promise<Coin.Coin>;
