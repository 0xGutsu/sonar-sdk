...
export declare class App {
    ...
    loadAllowedValidators(owner: HexString, loadFull?: boolean): Promise<AllowedValidators>;
    ...
    loadOwnerCapability(owner: HexString, loadFull?: boolean): Promise<OwnerCapability>;
    ...
    loadStakePool(owner: HexString, loadFull?: boolean): Promise<StakePool>;
    ...
    loadValidatorConfig(owner: HexString, loadFull?: boolean): Promise<ValidatorConfig>;
    get ValidatorInfo(): typeof ValidatorInfo;
    get ValidatorPerformance(): typeof ValidatorPerformance;
    loadValidatorPerformance(owner: HexString, loadFull?: boolean): Promise<ValidatorPerformance>;
    get ValidatorSet(): typeof ValidatorSet;
    loadValidatorSet(owner: HexString, loadFull?: boolean): Promise<ValidatorSet>;
    ...
    add_stake(_account: AptosAccount, amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    increase_lockup(_account: AptosAccount, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    initialize_stake_owner(_account: AptosAccount, initial_stake_amount: U64, operator: HexString, voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    initialize_validator(_account: AptosAccount, consensus_pubkey: U8[], proof_of_possession: U8[], network_addresses: U8[], fullnode_addresses: U8[], _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    join_validator_set(_account: AptosAccount, pool_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    leave_validator_set(_account: AptosAccount, pool_address: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    reactivate_stake(_account: AptosAccount, amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    rotate_consensus_key(_account: AptosAccount, pool_address: HexString, new_consensus_pubkey: U8[], proof_of_possession: U8[], _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_delegated_voter(_account: AptosAccount, new_voter: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    set_operator(_account: AptosAccount, new_operator: HexString, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    unlock(_account: AptosAccount, amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    update_network_and_fullnode_addresses(_account: AptosAccount, pool_address: HexString, new_network_addresses: U8[], new_fullnode_addresses: U8[], _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
    ...
    withdraw(_account: AptosAccount, withdraw_amount: U64, _maxGas?: number, _isJSON?: boolean): Promise<Types.UserTransaction>;
}
