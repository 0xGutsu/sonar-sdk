...
exports.App = exports.loadParsers = exports.remove_ = exports.empty_ = exports.contains_ = exports.borrow_mut_ = exports.borrow_ = exports.add_ = exports.OpenTable = exports.E_NO_KEY = exports.moduleName = exports.moduleAddress = exports.packageName = void 0;
...
exports.moduleName = "sonar_open_table";
exports.E_NO_KEY = (0, move_to_ts_1.u64)("0");
class OpenTable {
    ...
    static makeTag($p) {
        return new move_to_ts_2.StructTag(exports.moduleAddress, exports.moduleName, "OpenTable", $p);
    }
    loadFullState(app) {
...
OpenTable.fields = [
    { name: "base_table", typeTag: new move_to_ts_2.StructTag(new aptos_1.HexString("0x1"), "table", "Table", [new $.TypeParamIdx(0), new $.TypeParamIdx(1)]) },
    { name: "keys", typeTag: new move_to_ts_2.VectorTag(new $.TypeParamIdx(0)) }
];
...
function empty_($c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        return new OpenTable({ base_table: yield Stdlib.Table.new___($c, [$p[0], $p[1]]), keys: yield Stdlib.Vector.empty_($c, [$p[0]]) }, new move_to_ts_2.SimpleStructTag(OpenTable, [$p[0], $p[1]]));
    });
}
...
function remove_(table, key, $c, $p) {
    return __awaiter(this, void 0, void 0, function* () {
        let contains, i;
        [contains, i] = yield Stdlib.Vector.index_of_((table).keys, key, $c, [$p[0]]);
        if (!contains) {
            throw $.abortCode($.copy(exports.E_NO_KEY));
        }
        yield Stdlib.Vector.remove_((table).keys, $.copy(i), $c, [$p[0]]);
        return yield Stdlib.Table.remove_((table).base_table, $.copy(key), $c, [$p[0], $p[1]]);
    });
}
exports.remove_ = remove_;
function loadParsers(repo) {
    repo.addParser("0x7897a29478fbe6c29a476d245ad93149dcd998c9db81981f6adfa15db8bb0629::sonar_open_table::OpenTable", OpenTable.OpenTableParser);
}
...
exports.App = App;
//# sourceMappingURL=sonar_open_table.js.map