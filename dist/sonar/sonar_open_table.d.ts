...
export declare const moduleName = "sonar_open_table";
export declare const E_NO_KEY: U64;
...
export declare function remove_(table: OpenTable, key: any, $c: AptosDataCache, $p: TypeTag[]): Promise<any>;
...
//# sourceMappingURL=sonar_open_table.d.ts.map