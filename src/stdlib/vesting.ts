...
export const ROLE_BENEFICIARY_RESETTER : U8[] = [u8("82"), u8("79"), u8("76"), u8("69"), u8("95"), u8("66"), u8("69"), u8("78"), u8("69"), u8("70"), u8("73"), u8("67"), u8("73"), u8("65"), u8("82"), u8("89"), u8("95"), u8("82"), u8("69"), u8("83"), u8("69"), u8("84"), u8("84"), u8("69"), u8("82")];
export const VESTING_POOL_ACTIVE : U64 = u64("1");
export const VESTING_POOL_SALT : U8[] = [u8("97"), u8("112"), u8("116"), u8("111"), u8("115"), u8("95"), u8("102"), u8("114"), u8("97"), u8("109"), u8("101"), u8("119"), u8("111"), u8("114"), u8("107"), u8("58"), u8("58"), u8("118"), u8("101"), u8("115"), u8("116"), u8("105"), u8("110"), u8("103")];
...
export class AdminStore 
{
  ...
  static structName: string = "AdminStore";
  static typeParameters: TypeParamDeclType[] = [

  ];
  static fields: FieldDeclType[] = [
  { name: "vesting_contracts", typeTag: new VectorTag(AtomicTypeTag.Address) },
  { name: "nonce", typeTag: AtomicTypeTag.U64 },
  { name: "create_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "CreateVestingContractEvent", [])]) }];
  ...
  static async load(repo: AptosParserRepo, client: AptosClient, address: HexString, typeParams: TypeTag[]) {
    const result = await repo.loadResource(client, address, AdminStore, typeParams);
    return result as unknown as AdminStore;
  }
  static async loadByApp(app: $.AppType, address: HexString, typeParams: TypeTag[]) {
    const result = await app.repo.loadResource(app.client, address, AdminStore, typeParams);
...
export class AdminWithdrawEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "AdminWithdrawEvent";
  static typeParameters: TypeParamDeclType[] = [
  ...
  constructor(proto: any, public typeTag: TypeTag) {
    ...
    this.vesting_contract_address = proto['vesting_contract_address'] as HexString;
...
export class CreateVestingContractEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "CreateVestingContractEvent";
  static typeParameters: TypeParamDeclType[] = [
  ...
  static getTag(): StructTag {
    return new StructTag(moduleAddress, moduleName, "CreateVestingContractEvent", []);
  }
  async loadFullState(app: $.AppType) {
    this.__app = app;
  }
...
export class DistributeEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "DistributeEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class ResetLockupEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "ResetLockupEvent";
  static typeParameters: TypeParamDeclType[] = [
  ...
  constructor(proto: any, public typeTag: TypeTag) {
    ...
    this.vesting_contract_address = proto['vesting_contract_address'] as HexString;
    this.staking_pool_address = proto['staking_pool_address'] as HexString;
    this.new_lockup_expiration_secs = proto['new_lockup_expiration_secs'] as U64;
  }
...
export class SetBeneficiaryEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "SetBeneficiaryEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class StakingInfo 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "StakingInfo";
  static typeParameters: TypeParamDeclType[] = [
...
export class TerminateEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "TerminateEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class UnlockRewardsEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "UnlockRewardsEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class UpdateOperatorEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "UpdateOperatorEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class UpdateVoterEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "UpdateVoterEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class VestEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "VestEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export class VestingAccountManagement 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "VestingAccountManagement";
  static typeParameters: TypeParamDeclType[] = [

  ];
  static fields: FieldDeclType[] = [
  { name: "roles", typeTag: new StructTag(new HexString("0x1"), "simple_map", "SimpleMap", [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address]) }];
  ...
  static async load(repo: AptosParserRepo, client: AptosClient, address: HexString, typeParams: TypeTag[]) {
    const result = await repo.loadResource(client, address, VestingAccountManagement, typeParams);
    return result as unknown as VestingAccountManagement;
  }
  static async loadByApp(app: $.AppType, address: HexString, typeParams: TypeTag[]) {
    const result = await app.repo.loadResource(app.client, address, VestingAccountManagement, typeParams);
    await result.loadFullState(app)
    return result as unknown as VestingAccountManagement;
  }
  static getTag(): StructTag {
    return new StructTag(moduleAddress, moduleName, "VestingAccountManagement", []);
  }
  async loadFullState(app: $.AppType) {
...
export class VestingContract 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "VestingContract";
  static typeParameters: TypeParamDeclType[] = [
  ...
  { name: "admin", typeTag: AtomicTypeTag.Address },
  { name: "grant_pool", typeTag: new StructTag(new HexString("0x1"), "pool_u64", "Pool", []) },
  { name: "beneficiaries", typeTag: new StructTag(new HexString("0x1"), "simple_map", "SimpleMap", [AtomicTypeTag.Address, AtomicTypeTag.Address]) },
  { name: "vesting_schedule", typeTag: new StructTag(new HexString("0x1"), "vesting", "VestingSchedule", []) },
  { name: "withdrawal_address", typeTag: AtomicTypeTag.Address },
  { name: "staking", typeTag: new StructTag(new HexString("0x1"), "vesting", "StakingInfo", []) },
  ...
  { name: "update_operator_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "UpdateOperatorEvent", [])]) },
  { name: "update_voter_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "UpdateVoterEvent", [])]) },
  { name: "reset_lockup_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "ResetLockupEvent", [])]) },
  { name: "set_beneficiary_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "SetBeneficiaryEvent", [])]) },
  { name: "unlock_rewards_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "UnlockRewardsEvent", [])]) },
  { name: "vest_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "VestEvent", [])]) },
  { name: "distribute_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "DistributeEvent", [])]) },
  { name: "terminate_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "TerminateEvent", [])]) },
  { name: "admin_withdraw_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "vesting", "AdminWithdrawEvent", [])]) }];
  ...
  constructor(proto: any, public typeTag: TypeTag) {
    ...
    this.update_operator_events = proto['update_operator_events'] as Event.EventHandle;
    this.update_voter_events = proto['update_voter_events'] as Event.EventHandle;
    this.reset_lockup_events = proto['reset_lockup_events'] as Event.EventHandle;
    this.set_beneficiary_events = proto['set_beneficiary_events'] as Event.EventHandle;
    this.unlock_rewards_events = proto['unlock_rewards_events'] as Event.EventHandle;
    ...
    this.admin_withdraw_events = proto['admin_withdraw_events'] as Event.EventHandle;
  }
  ...
  static async load(repo: AptosParserRepo, client: AptosClient, address: HexString, typeParams: TypeTag[]) {
    const result = await repo.loadResource(client, address, VestingContract, typeParams);
    return result as unknown as VestingContract;
  }
  static async loadByApp(app: $.AppType, address: HexString, typeParams: TypeTag[]) {
    const result = await app.repo.loadResource(app.client, address, VestingContract, typeParams);
    await result.loadFullState(app)
    return result as unknown as VestingContract;
  }
  static getTag(): StructTag {
...
export class VestingSchedule 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "VestingSchedule";
  static typeParameters: TypeParamDeclType[] = [

  ];
  static fields: FieldDeclType[] = [
  { name: "schedule", typeTag: new VectorTag(new StructTag(new HexString("0x1"), "fixed_point32", "FixedPoint32", [])) },
...
export function admin_withdraw_ (
  ...
  vesting_contract = $c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(contract_address));
  if (!($.copy(vesting_contract.state)).eq(($.copy(VESTING_POOL_TERMINATED)))) {
    throw $.abortCode(Error.invalid_state_($.copy(EVESTING_CONTRACT_STILL_ACTIVE), $c));
  }
  vesting_contract__1 = $c.borrow_global_mut<VestingContract>(new SimpleStructTag(VestingContract), $.copy(contract_address));
  ...
  Coin.deposit_($.copy(vesting_contract__1.withdrawal_address), coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  Event.emit_event_(vesting_contract__1.admin_withdraw_events, new AdminWithdrawEvent({ admin: $.copy(vesting_contract__1.admin), vesting_contract_address: $.copy(contract_address), amount: $.copy(amount) }, new SimpleStructTag(AdminWithdrawEvent)), $c, [new SimpleStructTag(AdminWithdrawEvent)]);
  return;
}
...
export function assert_active_vesting_contract_ (
  ...
  if (!($.copy(vesting_contract.state)).eq(($.copy(VESTING_POOL_ACTIVE)))) {
    throw $.abortCode(Error.invalid_state_($.copy(EVESTING_CONTRACT_NOT_ACTIVE), $c));
  }
  return;
}
...
export function assert_vesting_contract_exists_ (
  ...
  if (!$c.exists(new SimpleStructTag(VestingContract), $.copy(contract_address))) {
    throw $.abortCode(Error.not_found_($.copy(EVESTING_CONTRACT_NOT_FOUND), $c));
  }
  return;
}
...
export function create_vesting_contract_ (
  ...
  if (!!System_addresses.is_reserved_address_($.copy(withdrawal_address), $c)) {
    throw $.abortCode(Error.invalid_argument_($.copy(EINVALID_WITHDRAWAL_ADDRESS), $c));
  }
  ...
  if (!(Simple_map.length_(buy_ins, $c, [AtomicTypeTag.Address, new StructTag(new HexString("0x1"), "coin", "Coin", [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])])])).eq((Vector.length_(shareholders, $c, [AtomicTypeTag.Address])))) {
    throw $.abortCode(Error.invalid_argument_($.copy(ESHARES_LENGTH_MISMATCH), $c));
  }
  grant = Coin.zero_($c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  grant_amount = u64("0");
  ...
  while (($.copy(i)).lt($.copy(len))) {
    {
      shareholder = $.copy(Vector.borrow_(shareholders, $.copy(i), $c, [AtomicTypeTag.Address]));
      [, buy_in] = Simple_map.remove_(buy_ins, shareholder, $c, [AtomicTypeTag.Address, new StructTag(new HexString("0x1"), "coin", "Coin", [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])])]);
      buy_in_amount = Coin.value_(buy_in, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
      Coin.merge_(grant, buy_in, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
      Pool_u64.buy_in_(grant_pool, $.copy(Vector.borrow_(shareholders, $.copy(i), $c, [AtomicTypeTag.Address])), $.copy(buy_in_amount), $c);
  ...
  admin_store = $c.borrow_global_mut<AdminStore>(new SimpleStructTag(AdminStore), $.copy(admin_address));
  Vector.push_back_(admin_store.vesting_contracts, $.copy(contract_address), $c, [AtomicTypeTag.Address]);
  ...
  Event.emit_event_(temp$8, new CreateVestingContractEvent({ operator: temp$1, voter: temp$2, grant_amount: temp$4, withdrawal_address: temp$3, vesting_contract_address: temp$5, staking_pool_address: temp$6, commission_percentage: temp$7 }, new SimpleStructTag(CreateVestingContractEvent)), $c, [new SimpleStructTag(CreateVestingContractEvent)]);
  $c.move_to(new SimpleStructTag(VestingContract), contract_signer, new VestingContract({ state: $.copy(VESTING_POOL_ACTIVE), admin: $.copy(admin_address), grant_pool: grant_pool, beneficiaries: Simple_map.create_($c, [AtomicTypeTag.Address, AtomicTypeTag.Address]), vesting_schedule: $.copy(vesting_schedule), withdrawal_address: $.copy(withdrawal_address), staking: new StakingInfo({ pool_address: $.copy(pool_address), operator: $.copy(operator), voter: $.copy(voter), commission_percentage: $.copy(commission_percentage) }, new SimpleStructTag(StakingInfo)), remaining_grant: $.copy(grant_amount), signer_cap: contract_signer_cap, update_operator_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(UpdateOperatorEvent)]), update_voter_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(UpdateVoterEvent)]), reset_lockup_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(ResetLockupEvent)]), set_beneficiary_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(SetBeneficiaryEvent)]), unlock_rewards_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(UnlockRewardsEvent)]), vest_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(VestEvent)]), distribute_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(DistributeEvent)]), terminate_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(TerminateEvent)]), admin_withdraw_events: Account.new_event_handle_(contract_signer, $c, [new SimpleStructTag(AdminWithdrawEvent)]) }, new SimpleStructTag(VestingContract)));
  Simple_map.destroy_empty_(buy_ins, $c, [AtomicTypeTag.Address, new StructTag(new HexString("0x1"), "coin", "Coin", [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])])]);
...
export function create_vesting_contract_account_ (
  ...
  admin_store = $c.borrow_global_mut<AdminStore>(new SimpleStructTag(AdminStore), Signer.address_of_(admin, $c));
  temp$1 = Signer.address_of_(admin, $c);
  seed = Bcs.to_bytes_(temp$1, $c, [AtomicTypeTag.Address]);
  Vector.append_(seed, Bcs.to_bytes_(admin_store.nonce, $c, [AtomicTypeTag.U64]), $c, [AtomicTypeTag.U8]);
  ...
  Coin.register_(account_signer, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
...
export function create_vesting_schedule_ (
  ...
  if (!(Vector.length_(schedule, $c, [new StructTag(new HexString("0x1"), "fixed_point32", "FixedPoint32", [])])).gt(u64("0"))) {
    throw $.abortCode(Error.invalid_argument_($.copy(EEMPTY_VESTING_SCHEDULE), $c));
  }
  if (!($.copy(period_duration)).gt(u64("0"))) {
    throw $.abortCode(Error.invalid_argument_($.copy(EZERO_VESTING_SCHEDULE_PERIOD), $c));
  }
  if (!($.copy(start_timestamp_secs)).ge(Timestamp.now_seconds_($c))) {
    throw $.abortCode(Error.invalid_argument_($.copy(EVESTING_START_TOO_SOON), $c));
  }
  return new VestingSchedule({ schedule: $.copy(schedule), start_timestamp_secs: $.copy(start_timestamp_secs), period_duration: $.copy(period_duration), last_vested_period: u64("0") }, new SimpleStructTag(VestingSchedule));
}
...
export function distribute_ (
  ...
  total_distribution_amount = Coin.value_(coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  ...
  while (($.copy(i)).lt($.copy(len))) {
    {
      ...
      share_of_coins = Coin.extract_(coins, $.copy(amount), $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
      [temp$4, temp$5] = [vesting_contract, $.copy(shareholder)];
      recipient_address = get_beneficiary_(temp$4, temp$5, $c);
      Coin.deposit_($.copy(recipient_address), share_of_coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
      i = ($.copy(i)).add(u64("1"));
    }

  }if ((Coin.value_(coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])])).gt(u64("0"))) {
    Coin.deposit_($.copy(vesting_contract.withdrawal_address), coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  }
  else{
    Coin.destroy_zero_(coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  }
  Event.emit_event_(vesting_contract.distribute_events, new DistributeEvent({ admin: $.copy(vesting_contract.admin), vesting_contract_address: $.copy(contract_address), amount: $.copy(total_distribution_amount) }, new SimpleStructTag(DistributeEvent)), $c, [new SimpleStructTag(DistributeEvent)]);
  return;
}
...
export function get_beneficiary_ (
  ...
  let temp$1;
  if (Simple_map.contains_key_(contract.beneficiaries, shareholder, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address])) {
    temp$1 = $.copy(Simple_map.borrow_(contract.beneficiaries, shareholder, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address]));
  }
  else{
...
export function get_role_holder_ (
  ...
  let roles;
  if (!$c.exists(new SimpleStructTag(VestingAccountManagement), $.copy(contract_address))) {
    throw $.abortCode(Error.not_found_($.copy(EVESTING_ACCOUNT_HAS_NO_ROLES), $c));
  }
  roles = $c.borrow_global<VestingAccountManagement>(new SimpleStructTag(VestingAccountManagement), $.copy(contract_address)).roles;
  if (!Simple_map.contains_key_(roles, role, $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address])) {
    throw $.abortCode(Error.not_found_($.copy(EROLE_NOT_FOUND), $c));
  }
  return $.copy(Simple_map.borrow_(roles, role, $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address]));
}
...
export function remaining_grant_ (
  ...
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy($c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)).remaining_grant);
}
...
export function reset_beneficiary_ (
  ...
  if ((($.copy(addr)).hex() === ($.copy(vesting_contract.admin)).hex())) {
    ...
    temp$1 = (($.copy(addr)).hex() === (get_role_holder_($.copy(contract_address), String.utf8_($.copy(ROLE_BENEFICIARY_RESETTER), $c), $c)).hex());
  }
  if (!temp$1) {
  ...
  if (Simple_map.contains_key_(temp$2, temp$3, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address])) {
    Simple_map.remove_(beneficiaries, shareholder, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address]);
  }
  else{
  }
  return;
...
export function set_beneficiary_ (
  ...
  if (Simple_map.contains_key_(temp$5, temp$6, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address])) {
    beneficiary = Simple_map.borrow_mut_(beneficiaries, shareholder, $c, [AtomicTypeTag.Address, AtomicTypeTag.Address]);
    $.set(beneficiary, $.copy(new_beneficiary));
  }
  else{
    Simple_map.add_(beneficiaries, $.copy(shareholder), $.copy(new_beneficiary), $c, [AtomicTypeTag.Address, AtomicTypeTag.Address]);
  }
  Event.emit_event_(vesting_contract.set_beneficiary_events, new SetBeneficiaryEvent({ admin: $.copy(vesting_contract.admin), vesting_contract_address: $.copy(contract_address), shareholder: $.copy(shareholder), old_beneficiary: $.copy(old_beneficiary), new_beneficiary: $.copy(new_beneficiary) }, new SimpleStructTag(SetBeneficiaryEvent)), $c, [new SimpleStructTag(SetBeneficiaryEvent)]);
  return;
}
...
export function set_beneficiary_resetter_ (
  ...
  set_management_role_(admin, $.copy(contract_address), String.utf8_($.copy(ROLE_BENEFICIARY_RESETTER), $c), $.copy(beneficiary_resetter), $c);
  return;
}
...
export function set_management_role_ (
  ...
  if (!$c.exists(new SimpleStructTag(VestingAccountManagement), $.copy(contract_address))) {
    temp$3 = get_vesting_account_signer_internal_(vesting_contract, $c);
    contract_signer = temp$3;
    $c.move_to(new SimpleStructTag(VestingAccountManagement), contract_signer, new VestingAccountManagement({ roles: Simple_map.create_($c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address]) }, new SimpleStructTag(VestingAccountManagement)));
  }
  else{
  }
  roles = $c.borrow_global_mut<VestingAccountManagement>(new SimpleStructTag(VestingAccountManagement), $.copy(contract_address)).roles;
  [temp$4, temp$5] = [roles, role];
  if (Simple_map.contains_key_(temp$4, temp$5, $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address])) {
    $.set(Simple_map.borrow_mut_(roles, role, $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address]), $.copy(role_holder));
  }
  else{
    Simple_map.add_(roles, $.copy(role), $.copy(role_holder), $c, [new StructTag(new HexString("0x1"), "string", "String", []), AtomicTypeTag.Address]);
  }
  return;
}
...
export function stake_pool_address_ (
  ...
  assert_vesting_contract_exists_($.copy(vesting_contract_address), $c);
  return $.copy($c.borrow_global<VestingContract>(new SimpleStructTag(VestingContract), $.copy(vesting_contract_address)).staking.pool_address);
}
...
export function terminate_vesting_contract_ (
  ...
  Event.emit_event_(vesting_contract.terminate_events, new TerminateEvent({ admin: $.copy(vesting_contract.admin), vesting_contract_address: $.copy(contract_address) }, new SimpleStructTag(TerminateEvent)), $c, [new SimpleStructTag(TerminateEvent)]);
  return;
}
...
export function update_voter_ (
  ...
  Event.emit_event_(vesting_contract.update_voter_events, new UpdateVoterEvent({ admin: $.copy(vesting_contract.admin), vesting_contract_address: $.copy(contract_address), staking_pool_address: $.copy(vesting_contract.staking.pool_address), old_voter: $.copy(old_voter), new_voter: $.copy(new_voter) }, new SimpleStructTag(UpdateVoterEvent)), $c, [new SimpleStructTag(UpdateVoterEvent)]);
  return;
}
...
export function withdraw_stake_ (
  ...
  withdrawn_coins = Coin.balance_($.copy(contract_address), $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  temp$1 = get_vesting_account_signer_internal_(vesting_contract, $c);
  contract_signer = temp$1;
  return Coin.withdraw_(contract_signer, $.copy(withdrawn_coins), $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
}
