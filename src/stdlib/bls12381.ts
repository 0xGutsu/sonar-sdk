...
export const RANDOM_SIGNATURE : U8[] = [u8("160"), u8("26"), u8("101"), u8("133"), u8("79"), u8("152"), u8("125"), u8("52"), u8("52"), u8("20"), u8("155"), u8("127"), u8("8"), u8("247"), u8("7"), u8("48"), u8("227"), u8("11"), u8("36"), u8("25"), u8("132"), u8("232"), u8("113"), u8("43"), u8("194"), u8("172"), u8("168"), u8("133"), u8("214"), u8("50"), u8("170"), u8("252"), u8("237"), u8("76"), u8("63"), u8("102"), u8("18"), u8("9"), u8("222"), u8("187"), u8("107"), u8("28"), u8("134"), u8("1"), u8("50"), u8("102"), u8("35"), u8("204"), u8("22"), u8("202"), u8("47"), u8("108"), u8("158"), u8("220"), u8("83"), u8("183"), u8("184"), u8("139"), u8("116"), u8("53"), u8("251"), u8("107"), u8("5"), u8("221"), u8("236"), u8("228"), u8("24"), u8("210"), u8("195"), u8("77"), u8("198"), u8("172"), u8("162"), u8("245"), u8("161"), u8("26"), u8("121"), u8("230"), u8("119"), u8("116"), u8("88"), u8("44"), u8("20"), u8("8"), u8("74"), u8("1"), u8("220"), u8("183"), u8("130"), u8("14"), u8("76"), u8("180"), u8("186"), u8("208"), u8("234"), u8("141")];
...
export class AggrOrMultiSignature 
{
  ...
  static structName: string = "AggrOrMultiSignature";
...
export class AggrPublicKeysWithPoP 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "AggrPublicKeysWithPoP";
  static typeParameters: TypeParamDeclType[] = [
  ...
  static getTag(): StructTag {
    return new StructTag(moduleAddress, moduleName, "AggrPublicKeysWithPoP", []);
  }
  async loadFullState(app: $.AppType) {
    this.__app = app;
  }
...
export class ProofOfPossession 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "ProofOfPossession";
  static typeParameters: TypeParamDeclType[] = [
...
export class PublicKey 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "PublicKey";
  static typeParameters: TypeParamDeclType[] = [
...
export class PublicKeyWithPoP 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "PublicKeyWithPoP";
  static typeParameters: TypeParamDeclType[] = [
...
export function aggregate_pubkeys_ (
  ...
  return new AggrPublicKeysWithPoP({ bytes: $.copy(bytes) }, new SimpleStructTag(AggrPublicKeysWithPoP));
}
...
export function aggregate_signatures_ (
  ...
  if (success) {
    temp$1 = Option.some_(new AggrOrMultiSignature({ bytes: $.copy(bytes) }, new SimpleStructTag(AggrOrMultiSignature)), $c, [new SimpleStructTag(AggrOrMultiSignature)]);
  }
  else{
...
export function proof_of_possession_from_bytes_ (
  ...
  return new ProofOfPossession({ bytes: $.copy(bytes) }, new SimpleStructTag(ProofOfPossession));
}
...
export function public_key_from_bytes_ (
  ...
  if (validate_pubkey_internal_($.copy(bytes), $c)) {
    temp$1 = Option.some_(new PublicKey({ bytes: $.copy(bytes) }, new SimpleStructTag(PublicKey)), $c, [new SimpleStructTag(PublicKey)]);
  }
  else{
...
export function public_key_from_bytes_with_pop_ (
  ...
  if (verify_proof_of_possession_internal_($.copy(pk_bytes), $.copy(pop.bytes), $c)) {
    temp$1 = Option.some_(new PublicKeyWithPoP({ bytes: $.copy(pk_bytes) }, new SimpleStructTag(PublicKeyWithPoP)), $c, [new SimpleStructTag(PublicKeyWithPoP)]);
  }
  else{
...
export function public_key_to_bytes_ (
  pk: PublicKey,
  $c: AptosDataCache,
): U8[] {
