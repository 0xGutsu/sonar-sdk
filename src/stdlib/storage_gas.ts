...
export function initialize_ (
  ...
  $c.move_to(new SimpleStructTag(StorageGas), aptos_framework, new StorageGas({ per_item_read: u64("80000"), per_item_create: u64("2000000"), per_item_write: u64("400000"), per_byte_read: u64("40"), per_byte_create: u64("1000"), per_byte_write: u64("200") }, new SimpleStructTag(StorageGas)));
  return;
}
