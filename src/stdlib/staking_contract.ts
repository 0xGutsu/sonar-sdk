...
export const SALT : U8[] = [u8("97"), u8("112"), u8("116"), u8("111"), u8("115"), u8("95"), u8("102"), u8("114"), u8("97"), u8("109"), u8("101"), u8("119"), u8("111"), u8("114"), u8("107"), u8("58"), u8("58"), u8("115"), u8("116"), u8("97"), u8("107"), u8("105"), u8("110"), u8("103"), u8("95"), u8("99"), u8("111"), u8("110"), u8("116"), u8("114"), u8("97"), u8("99"), u8("116")];
...
export class AddDistributionEvent 
{
  ...
  static structName: string = "AddDistributionEvent";
...
export class CreateStakingContractEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "CreateStakingContractEvent";
  static typeParameters: TypeParamDeclType[] = [
  ...
  static getTag(): StructTag {
    return new StructTag(moduleAddress, moduleName, "CreateStakingContractEvent", []);
  }
  async loadFullState(app: $.AppType) {
    this.__app = app;
  }
...
export class RequestCommissionEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "RequestCommissionEvent";
  static typeParameters: TypeParamDeclType[] = [
  ...
  static getTag(): StructTag {
    return new StructTag(moduleAddress, moduleName, "RequestCommissionEvent", []);
  }
  async loadFullState(app: $.AppType) {
    this.__app = app;
  }
...
export class StakingContract 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "StakingContract";
  static typeParameters: TypeParamDeclType[] = [
  ...
  { name: "principal", typeTag: AtomicTypeTag.U64 },
  { name: "pool_address", typeTag: AtomicTypeTag.Address },
  { name: "owner_cap", typeTag: new StructTag(new HexString("0x1"), "stake", "OwnerCapability", []) },
  { name: "commission_percentage", typeTag: AtomicTypeTag.U64 },
  { name: "distribution_pool", typeTag: new StructTag(new HexString("0x1"), "pool_u64", "Pool", []) },
...
export class Store 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "Store";
  static typeParameters: TypeParamDeclType[] = [

  ];
  static fields: FieldDeclType[] = [
  { name: "staking_contracts", typeTag: new StructTag(new HexString("0x1"), "simple_map", "SimpleMap", [AtomicTypeTag.Address, new StructTag(new HexString("0x1"), "staking_contract", "StakingContract", [])]) },
  { name: "create_staking_contract_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "CreateStakingContractEvent", [])]) },
  { name: "update_voter_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "UpdateVoterEvent", [])]) },
  { name: "reset_lockup_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "ResetLockupEvent", [])]) },
  { name: "add_stake_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "AddStakeEvent", [])]) },
  { name: "request_commission_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "RequestCommissionEvent", [])]) },
  { name: "unlock_stake_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "UnlockStakeEvent", [])]) },
  { name: "switch_operator_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "SwitchOperatorEvent", [])]) },
  { name: "add_distribution_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "AddDistributionEvent", [])]) },
  { name: "distribute_events", typeTag: new StructTag(new HexString("0x1"), "event", "EventHandle", [new StructTag(new HexString("0x1"), "staking_contract", "DistributeEvent", [])]) }];
  ...
  constructor(proto: any, public typeTag: TypeTag) {
    ...
    this.create_staking_contract_events = proto['create_staking_contract_events'] as Event.EventHandle;
    ...
    this.request_commission_events = proto['request_commission_events'] as Event.EventHandle;
    this.unlock_stake_events = proto['unlock_stake_events'] as Event.EventHandle;
    this.switch_operator_events = proto['switch_operator_events'] as Event.EventHandle;
    this.add_distribution_events = proto['add_distribution_events'] as Event.EventHandle;
  ...
  static async loadByApp(app: $.AppType, address: HexString, typeParams: TypeTag[]) {
    const result = await app.repo.loadResource(app.client, address, Store, typeParams);
...
export class SwitchOperatorEvent 
{
  ...
  static moduleName = moduleName;
  __app: $.AppType | null = null;
  static structName: string = "SwitchOperatorEvent";
  static typeParameters: TypeParamDeclType[] = [
...
export function add_distribution_ (
  ...
  Event.emit_event_(add_distribution_events, new AddDistributionEvent({ operator: $.copy(operator), pool_address: $.copy(pool_address), amount: $.copy(coins_amount) }, new SimpleStructTag(AddDistributionEvent)), $c, [new SimpleStructTag(AddDistributionEvent)]);
  return;
}
...
export function add_stake_ (
  ...
  store = $c.borrow_global_mut<Store>(new SimpleStructTag(Store), $.copy(staker_address));
  staking_contract = Simple_map.borrow_mut_(store.staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
  staked_coins = Coin.withdraw_(staker, $.copy(amount), $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  ...
  pool_address = $.copy(staking_contract.pool_address);
  Event.emit_event_(store.add_stake_events, new AddStakeEvent({ operator: $.copy(operator), pool_address: $.copy(pool_address), amount: $.copy(amount) }, new SimpleStructTag(AddStakeEvent)), $c, [new SimpleStructTag(AddStakeEvent)]);
  return;
}
...
export function assert_staking_contract_exists_ (
  ...
  if (!$c.exists(new SimpleStructTag(Store), $.copy(staker))) {
    throw $.abortCode(Error.not_found_($.copy(ENO_STAKING_CONTRACT_FOUND_FOR_STAKER), $c));
  }
  staking_contracts = $c.borrow_global_mut<Store>(new SimpleStructTag(Store), $.copy(staker)).staking_contracts;
  [temp$1, temp$2] = [staking_contracts, operator];
  if (!Simple_map.contains_key_(temp$1, temp$2, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)])) {
    throw $.abortCode(Error.not_found_($.copy(ENO_STAKING_CONTRACT_FOUND_FOR_OPERATOR), $c));
  }
  return;
}
...
export function commission_percentage_ (
  ...
  return $.copy(Simple_map.borrow_(staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]).commission_percentage);
}
...
export function create_stake_pool_ (
  ...
  Vector.append_(seed, Bcs.to_bytes_(operator, $c, [AtomicTypeTag.Address]), $c, [AtomicTypeTag.U8]);
  ...
  Stake.initialize_stake_owner_(stake_pool_signer, u64("0"), $.copy(operator), $.copy(voter), $c);
...
export function create_staking_contract_with_coins_ (
  ...
  if (!temp$1) {
    throw $.abortCode(Error.invalid_argument_($.copy(EINVALID_COMMISSION_PERCENTAGE), $c));
  }
  temp$2 = Staking_config.get_($c);
  [min_stake_required, ] = Staking_config.get_required_stake_(temp$2, $c);
  principal = Coin.value_(coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  if (!($.copy(principal)).ge($.copy(min_stake_required))) {
    throw $.abortCode(Error.invalid_argument_($.copy(EINSUFFICIENT_STAKE_AMOUNT), $c));
  }
  staker_address = Signer.address_of_(staker, $c);
  if (!$c.exists(new SimpleStructTag(Store), $.copy(staker_address))) {
    $c.move_to(new SimpleStructTag(Store), staker, new_staking_contracts_holder_(staker, $c));
  }
  else{
  }
  store = $c.borrow_global_mut<Store>(new SimpleStructTag(Store), $.copy(staker_address));
  ...
  if (!!Simple_map.contains_key_(temp$3, temp$4, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)])) {
    throw $.abortCode(Error.already_exists_($.copy(ESTAKING_CONTRACT_ALREADY_EXISTS), $c));
  }
...
export function distribute_ (
  ...
  assert_staking_contract_exists_($.copy(staker), $.copy(operator), $c);
  store = $c.borrow_global_mut<Store>(new SimpleStructTag(Store), $.copy(staker));
  staking_contract = Simple_map.borrow_mut_(store.staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
...
export function distribute_internal_ (
  ...
  distribution_amount = Coin.value_(coins, $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
  ...
  while ((Pool_u64.shareholders_count_(distribution_pool, $c)).gt(u64("0"))) {
    {
      ...
      recipient = $.copy(Vector.borrow_(temp$1, temp$2, $c, [AtomicTypeTag.Address]));
      ...
      Coin.deposit_($.copy(recipient), Coin.extract_(coins, $.copy(amount_to_distribute), $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]), $c, [new StructTag(new HexString("0x1"), "aptos_coin", "AptosCoin", [])]);
      Event.emit_event_(distribute_events, new DistributeEvent({ operator: $.copy(operator), pool_address: $.copy(pool_address), recipient: $.copy(recipient), amount: $.copy(amount_to_distribute) }, new SimpleStructTag(DistributeEvent)), $c, [new SimpleStructTag(DistributeEvent)]);
    }
...
export function get_staking_contract_amounts_internal_ (
  ...
  commission_amount = (($.copy(accumulated_rewards)).mul($.copy(staking_contract.commission_percentage))).div(u64("100"));
...
export function last_recorded_principal_ (
  ...
  assert_staking_contract_exists_($.copy(staker), $.copy(operator), $c);
  staking_contracts = $c.borrow_global<Store>(new SimpleStructTag(Store), $.copy(staker)).staking_contracts;
  return $.copy(Simple_map.borrow_(staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]).principal);
}
...
export function new_staking_contracts_holder_ (
  ...
  return new Store({ staking_contracts: Simple_map.create_($c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]), create_staking_contract_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(CreateStakingContractEvent)]), update_voter_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(UpdateVoterEvent)]), reset_lockup_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(ResetLockupEvent)]), add_stake_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(AddStakeEvent)]), request_commission_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(RequestCommissionEvent)]), unlock_stake_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(UnlockStakeEvent)]), switch_operator_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(SwitchOperatorEvent)]), add_distribution_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(AddDistributionEvent)]), distribute_events: Account.new_event_handle_(staker, $c, [new SimpleStructTag(DistributeEvent)]) }, new SimpleStructTag(Store));
}
...
export function pending_distribution_counts_ (
  ...
  assert_staking_contract_exists_($.copy(staker), $.copy(operator), $c);
  staking_contracts = $c.borrow_global<Store>(new SimpleStructTag(Store), $.copy(staker)).staking_contracts;
  return Pool_u64.shareholders_count_(Simple_map.borrow_(staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]).distribution_pool, $c);
}
...
export function request_commission_ (
  ...
  if (!temp$1) {
    throw $.abortCode(Error.unauthenticated_($.copy(ENOT_STAKER_OR_OPERATOR), $c));
  }
  assert_staking_contract_exists_($.copy(staker), $.copy(operator), $c);
  store = $c.borrow_global_mut<Store>(new SimpleStructTag(Store), $.copy(staker));
  staking_contract = Simple_map.borrow_mut_(store.staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
...
export function request_commission_internal_ (
  ...
  pool_address = $.copy(staking_contract.pool_address);
  Event.emit_event_(request_commission_events, new RequestCommissionEvent({ operator: $.copy(operator), pool_address: $.copy(pool_address), accumulated_rewards: $.copy(accumulated_rewards), commission_amount: $.copy(commission_amount) }, new SimpleStructTag(RequestCommissionEvent)), $c, [new SimpleStructTag(RequestCommissionEvent)]);
...
export function reset_lockup_ (
  ...
  Event.emit_event_(store.reset_lockup_events, new ResetLockupEvent({ operator: $.copy(operator), pool_address: $.copy(pool_address) }, new SimpleStructTag(ResetLockupEvent)), $c, [new SimpleStructTag(ResetLockupEvent)]);
  return;
}
...
export function stake_pool_address_ (
  ...
  assert_staking_contract_exists_($.copy(staker), $.copy(operator), $c);
  staking_contracts = $c.borrow_global<Store>(new SimpleStructTag(Store), $.copy(staker)).staking_contracts;
  return $.copy(Simple_map.borrow_(staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]).pool_address);
}
...
export function staking_contract_amounts_ (
  ...
  assert_staking_contract_exists_($.copy(staker), $.copy(operator), $c);
  staking_contracts = $c.borrow_global<Store>(new SimpleStructTag(Store), $.copy(staker)).staking_contracts;
  staking_contract = Simple_map.borrow_(staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
...
export function staking_contract_exists_ (
  ...
  return Simple_map.contains_key_(store.staking_contracts, operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
}
...
export function switch_operator_ (
  ...
  if (!!Simple_map.contains_key_(temp$1, temp$2, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)])) {
    throw $.abortCode(Error.invalid_state_($.copy(ECANT_MERGE_STAKING_CONTRACTS), $c));
  }
  [, staking_contract] = Simple_map.remove_(staking_contracts, old_operator, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
  ...
  pool_address = $.copy(staking_contract.pool_address);
  Simple_map.add_(staking_contracts, $.copy(new_operator), staking_contract, $c, [AtomicTypeTag.Address, new SimpleStructTag(StakingContract)]);
  temp$6 = store.switch_operator_events;
  temp$3 = $.copy(pool_address);
  temp$4 = $.copy(old_operator);
  temp$5 = $.copy(new_operator);
  Event.emit_event_(temp$6, new SwitchOperatorEvent({ old_operator: temp$4, new_operator: temp$5, pool_address: temp$3 }, new SimpleStructTag(SwitchOperatorEvent)), $c, [new SimpleStructTag(SwitchOperatorEvent)]);
  return;
}
...
export function unlock_stake_ (
  ...
  Event.emit_event_(temp$5, new UnlockStakeEvent({ operator: temp$2, pool_address: temp$1, amount: temp$3, commission_paid: temp$4 }, new SimpleStructTag(UnlockStakeEvent)), $c, [new SimpleStructTag(UnlockStakeEvent)]);
  return;
}
  ...
  while (($.copy(i)).lt($.copy(len))) {
    {
      ...
      if ((($.copy(shareholder)).hex() !== ($.copy(operator)).hex())) {
        ...
        unpaid_commission = ((($.copy(current_worth)).sub($.copy(previous_worth))).mul($.copy(commission_percentage))).div(u64("100"));
...
export function update_voter_ (
  ...
  Event.emit_event_(store.update_voter_events, new UpdateVoterEvent({ operator: $.copy(operator), pool_address: $.copy(pool_address), old_voter: $.copy(old_voter), new_voter: $.copy(new_voter) }, new SimpleStructTag(UpdateVoterEvent)), $c, [new SimpleStructTag(UpdateVoterEvent)]);
  return;
}
