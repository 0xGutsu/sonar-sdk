...
export class MarketInfo 
{
  ...
  { name: "trading_pair_info", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "registry", "TradingPairInfo", []) }];
...
export class Registry 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "hosts", typeTag: new StructTag(new HexString("0x1"), "table", "Table", [new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "registry", "TradingPairInfo", []), AtomicTypeTag.Address]) },
  { name: "markets", typeTag: new VectorTag(new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "registry", "MarketInfo", [])) },
...
export function get_verified_market_custodian_id_ (
  ...
  if (!$c.exists(new SimpleStructTag(Registry), new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"))) {
    throw $.abortCode($.copy(E_NO_REGISTRY));
  }
  registry_ref = $c.borrow_global<Registry>(new SimpleStructTag(Registry), new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"));
...
export function n_custodians_ (
  ...
  return $.copy($c.borrow_global<Registry>(new SimpleStructTag(Registry), new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa")).n_custodians);
}
...
export function n_markets_ (
  ...
  return Stdlib.Vector.length_($c.borrow_global<Registry>(new SimpleStructTag(Registry), new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa")).markets, $c, [new SimpleStructTag(MarketInfo)]);
}
...
export function register_custodian_capability_ (
  ...
  registry_ref_mut = $c.borrow_global_mut<Registry>(new SimpleStructTag(Registry), new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"));
...
export function set_registered_custodian_test_ (
  ...
  $c.borrow_global_mut<Registry>(new SimpleStructTag(Registry), new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa")).n_custodians = $.copy(custodian_id);
  return;
}
