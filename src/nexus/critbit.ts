...
export class CritBitTree 
{
  ...
  { name: "inner_nodes", typeTag: new VectorTag(new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "critbit", "InnerNode", [])) },
  { name: "outer_nodes", typeTag: new VectorTag(new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "critbit", "OuterNode", [new $.TypeParamIdx(0)])) }];
...
export function borrow_closest_outer_node_ (
  ...
  if (is_outer_node_($.copy(tree.root), $c)) {
    return Stdlib.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(tree.root), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  }
  else{
  }
  ...
  while (true) {
    ...
    if (is_outer_node_($.copy(child_index), $c)) {
      return Stdlib.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
    }
    else{
    }
...
export function borrow_closest_outer_node_mut_ (
  ...
  let temp$1, child_index, node;
  if (is_outer_node_($.copy(tree.root), $c)) {
    return Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(tree.root), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
  }
  else{
  }
  node = Stdlib.Vector.borrow_(tree.inner_nodes, $.copy(tree.root), $c, [new SimpleStructTag(InnerNode)]);
  while (true) {
    ...
    child_index = temp$1;
    if (is_outer_node_($.copy(child_index), $c)) {
      return Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
    }
    else{
    }
    node = Stdlib.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]);
...
export function insert_above_root_ (
  ...
  push_back_insert_nodes_(tree, $.copy(key), value, $.copy(n_inner_nodes), $.copy(critical_bit), $.copy(ROOT), is_set_($.copy(key), $.copy(critical_bit), $c), $.copy(old_root_index), outer_node_child_index_($.copy(n_outer_nodes), $c), $c, [$p[0]]);
  return;
}
...
export function insert_below_ (
  ...
  Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(search_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = $.copy(n_inner_nodes);
...
export function insert_below_walk_ (
  ...
  if (is_set_($.copy(key), $.copy(review_node.critical_bit), $c)) {
    [temp$1, temp$2] = [$.copy(RIGHT), $.copy(review_node.right_child_index)];
  }
  else{
    [temp$1, temp$2] = [$.copy(LEFT), $.copy(review_node.left_child_index)];
  }
...
export function insert_singleton_ (
  ...
  push_back_insert_nodes_(tree, $.copy(key), value, u64("0"), $.copy(critical_bit), $.copy(ROOT), ($.copy(key)).gt($.copy(outer_node.key)), outer_node_child_index_(u64("0"), $c), outer_node_child_index_(u64("1"), $c), $c, [$p[0]]);
  tree.root = u64("0");
...
export function max_key_ (
  ...
  return $.copy(Stdlib.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_(max_node_child_index_(tree, $c, [$p[0]]), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).key);
}
...
export function min_key_ (
  ...
  return $.copy(Stdlib.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_(min_node_child_index_(tree, $c, [$p[0]]), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).key);
}
...
export function pop_destroy_nodes_ (
  ...
  let { value: value } = Stdlib.Vector.swap_remove_(tree.outer_nodes, outer_node_vector_index_($.copy(outer_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function pop_update_relationships_ (
  ...
  if (is_outer_node_($.copy(sibling_index), $c)) {
    Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(sibling_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = $.copy(grandparent_index);
  }
  else{
...
export function search_outer_ (
  ...
  while (true) {
    if (is_set_($.copy(key), $.copy(parent.critical_bit), $c)) {
      [temp$1, temp$2] = [$.copy(parent.right_child_index), $.copy(RIGHT)];
    }
    else{
      [temp$1, temp$2] = [$.copy(parent.left_child_index), $.copy(LEFT)];
    }
    [index, side] = [temp$1, temp$2];
    if (is_outer_node_($.copy(index), $c)) {
      node = Stdlib.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function stitch_parent_of_child_ (
  ...
  if (is_outer_node_($.copy(child_index), $c)) {
    Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index = $.copy(new_index);
  }
  else{
...
export function stitch_swap_remove_ (
  ...
  if (is_outer_node_($.copy(node_index), $c)) {
    parent_index = $.copy(Stdlib.Vector.borrow_(tree.outer_nodes, outer_node_vector_index_($.copy(node_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]).parent_index);
...
export function traverse_init_mut_ (
  ...
  node = Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(child_field_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function traverse_mut_ (
  ...
  node = Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(target_child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function traverse_pop_mut_ (
  ...
  target_node = Stdlib.Vector.borrow_mut_(tree.outer_nodes, outer_node_vector_index_($.copy(target_child_index), $c), $c, [new SimpleStructTag(OuterNode, [$p[0]])]);
...
export function traverse_predecessor_init_mut_ (
  ...
  return traverse_init_mut_(tree, $.copy(LEFT), $c, [$p[0]]);
}
...
export function traverse_predecessor_mut_ (
  ...
  return traverse_mut_(tree, $.copy(key), $.copy(parent_index), $.copy(LEFT), $c, [$p[0]]);
}
...
export function traverse_predecessor_pop_mut_ (
  ...
  return traverse_pop_mut_(tree, $.copy(key), $.copy(parent_index), $.copy(child_index), $.copy(n_outer_nodes), $.copy(LEFT), $c, [$p[0]]);
}
...
export function traverse_successor_init_mut_ (
  ...
  return traverse_init_mut_(tree, $.copy(RIGHT), $c, [$p[0]]);
}
...
export function traverse_successor_mut_ (
  ...
  return traverse_mut_(tree, $.copy(key), $.copy(parent_index), $.copy(RIGHT), $c, [$p[0]]);
}
...
export function traverse_successor_pop_mut_ (
  ...
  return traverse_pop_mut_(tree, $.copy(key), $.copy(parent_index), $.copy(child_index), $.copy(n_outer_nodes), $.copy(RIGHT), $c, [$p[0]]);
}
...
export function traverse_target_child_index_ (
  ...
  while (!is_outer_node_($.copy(child_index), $c)) {
    {
      if ((direction == $.copy(LEFT))) {
        temp$2 = $.copy(Stdlib.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]).right_child_index);
      }
      else{
        temp$2 = $.copy(Stdlib.Vector.borrow_(tree.inner_nodes, $.copy(child_index), $c, [new SimpleStructTag(InnerNode)]).left_child_index);
      }
      child_index = temp$2;
    }
