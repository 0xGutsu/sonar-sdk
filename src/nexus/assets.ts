...
export function init_all_coin_types_(
  ...
  init_coin_type_(
    account,
    [u8("65"), u8("112"), u8("116"), u8("111"), u8("115")],
    [u8("65"), u8("80"), u8("84")],
    $.copy(QUOTE_COIN_DECIMALS),
    $c,
    [new SimpleStructTag(APT)]
  );
  init_coin_type_(
    account,
    [u8("83"), u8("117"), u8("105")],
  ...
  init_coin_type_(
    ...
    [u8("85"), u8("83"), u8("68"), u8("67")],
    $.copy(QUOTE_COIN_DECIMALS),
    $c,
    [new SimpleStructTag(USDC)]
  );
  init_coin_type_(
    account,
    [
    ...
    [u8("85"), u8("83"), u8("68"), u8("84")],
    $.copy(QUOTE_COIN_DECIMALS),
    $c,
    [new SimpleStructTag(USDT)]
  );
  init_coin_type_(
    account,
    [u8("66"), u8("105"), u8("116"), u8("99"), u8("111"), u8("105"), u8("110")],
    [u8("66"), u8("84"), u8("67")],
    $.copy(QUOTE_COIN_DECIMALS),
    $c,
    [new SimpleStructTag(BTC)]
  );
  init_coin_type_(
    account,
    [
...
export function init_coin_types_(account: HexString, $c: AptosDataCache): void {
  init_coin_type_(
    account,
    $.copy(BASE_COIN_NAME),
    $.copy(BASE_COIN_SYMBOL),
