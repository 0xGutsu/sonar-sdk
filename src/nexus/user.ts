...
export class Collateral 
{
  ...
  { name: "map", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "open_table", "OpenTable", [AtomicTypeTag.U128, new StructTag(new HexString("0x1"), "coin", "Coin", [new $.TypeParamIdx(0)])]) }];
...
export class MarketAccount 
{
  ...
  { name: "asks", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "critbit", "CritBitTree", [AtomicTypeTag.U64]) },
  { name: "bids", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "critbit", "CritBitTree", [AtomicTypeTag.U64]) },
...
export class MarketAccounts 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "map", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "open_table", "OpenTable", [AtomicTypeTag.U128, new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "user", "MarketAccount", [])]) }];
