...
export class OrderBook 
{
  ...
  { name: "asks", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "critbit", "CritBitTree", [new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "market", "Order", [])]) },
  { name: "bids", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "critbit", "CritBitTree", [new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "market", "Order", [])]) },
...
export class OrderBooks 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "map", typeTag: new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "open_table", "OpenTable", [AtomicTypeTag.U64, new StructTag(new HexString("0x91f6206a9ee4f969adf1e987b11a6a7ff4848fdb63b90f05ecd8a1a73b0e3efa"), "market", "OrderBook", [])]) }];
...
export function match_ (
  ...
  target_order_ids = Stdlib.Vector.empty_($c, [AtomicTypeTag.U128]);
...
export function match_loop_ (
  ...
  target_order_ids = Stdlib.Vector.empty_($c, [AtomicTypeTag.U128]);
  Stdlib.Vector.push_back_(target_order_ids, $.copy(target_order_id), $c, [AtomicTypeTag.U128]);
  while (true) {
...
export function place_limit_order_ (
  ...
  if (($.copy(size_ref)).eq((u64("0")))) {
    return [u64("0"), u64("0"), u128("0"), Stdlib.Vector.empty_($c, [AtomicTypeTag.U128])];
  }
  else{
  }
...
export function buildPayload_register_market_generic (
  lot_size: U64,
  tick_size: U64,
  generic_asset_transfer_custodian_id: U64,
  $p: TypeTag[], /* <BaseType, QuoteType>*/
...
export class App {
  ...
  payload_register_market_generic(
    lot_size: U64,
    tick_size: U64,
    generic_asset_transfer_custodian_id: U64,
    $p: TypeTag[], /* <BaseType, QuoteType>*/
